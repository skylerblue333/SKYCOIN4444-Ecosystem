...
export const xpEvents = mysqlTable(
  "xp_events",
  {
    ...
    receiverId: int("user_id").notNull(), // Legacy alias
    action: varchar("action", { length: 64 }).notNull(),
    xpAwarded: int("xp_awarded").notNull(),
    amount: int("xp_awarded").notNull(), // Legacy alias
    bonusMultiplier: decimal("bonus_multiplier", {
      precision: 4,
      scale: 2,
    }).default("1.00"),
...
export const wagers = mysqlTable(
  "wagers",
  {
...
export const battlePassProgress = mysqlTable(
  ...
  t => ({
    userPassIdx: uniqueIndex("bp_progress_user_pass_idx").on(
      t.userId,
      t.battlePassId
    ),
  })
...
export const dailyChallenges = mysqlTable(
  "daily_challenges",
  {
    ...
    tokenReward: decimal("token_reward", { precision: 18, scale: 8 }).default(
      "0"
    ),
    createdAt: timestamp("created_at").defaultNow().notNull(),
  },
...
export const dailyChallengeCompletions = mysqlTable(
  ...
  t => ({
    challengeUserIdx: uniqueIndex("dc_completions_challenge_user_idx").on(
      t.challengeId,
      t.userId
    ),
  })
...
export const leaderboardEntries = mysqlTable(
  ...
  t => ({
    typeUserPeriodIdx: uniqueIndex("lb_type_user_period_idx").on(
      t.leaderboardType,
      t.userId,
      t.period
    ),
...
export const carts = mysqlTable(
  "carts",
  {
    ...
    userId: int("user_id").notNull(),
    items: json("items")
      .$type<Array<{ listingId: number; quantity: number; price: number }>>()
      .default([]),
    affiliateCode: varchar("affiliate_code", { length: 32 }),
    subtotal: decimal("subtotal", { precision: 18, scale: 2 }).default("0"),
    platformFee: decimal("platform_fee", { precision: 18, scale: 2 }).default(
      "0"
    ),
...
export const disputes = mysqlTable(
  "disputes",
  {
    ...
    evidence: json("evidence")
      .$type<
        Array<{ submittedBy: number; content: string; submittedAt: string }>
      >()
      .default([]),
    status: varchar("status", { length: 32 }).default("open").notNull(),
...
export const affiliateLinks = mysqlTable(
  "affiliate_links",
  {
    ...
    totalEarned: decimal("total_earned", { precision: 18, scale: 2 }).default(
      "0"
    ),
...
export const walletConnections = mysqlTable(
  "wallet_connections",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    userId: int("user_id").notNull(),
...
export const stakingRecords = mysqlTable(
  "staking_records",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    userId: int("user_id").notNull(),
    ...
    rewardsAccrued: decimal("rewards_accrued", {
      precision: 36,
      scale: 18,
    }).default("0"),
...
export const swapExecutions = mysqlTable(
  "swap_executions",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    userId: int("user_id").notNull(),
    ...
    executedRate: decimal("executed_rate", {
      precision: 36,
      scale: 18,
    }).notNull(),
...
export const vestingSchedules = mysqlTable(
  "vesting_schedules",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    userId: int("user_id").notNull(),
    ...
    vestedAmount: decimal("vested_amount", {
      precision: 36,
      scale: 18,
    }).default("0"),
...
export const governanceProposals = mysqlTable(
  "governance_proposals",
  {
    ...
    votesAgainst: decimal("votes_against", {
      precision: 36,
      scale: 18,
    }).default("0"),
    quorumRequired: decimal("quorum_required", {
      precision: 36,
      scale: 18,
    }).notNull(),
...
export const governanceVotes = mysqlTable(
  "governance_votes",
  {
    ...
    votingPower: decimal("voting_power", {
      precision: 36,
      scale: 18,
    }).notNull(),
    createdAt: timestamp("created_at").defaultNow().notNull(),
  ...
  t => ({
    proposalVoterIdx: uniqueIndex("gov_votes_proposal_voter_idx").on(
      t.proposalId,
      t.voterId
    ),
  })
...
export const referralLinks = mysqlTable(
  "referral_links",
  {
    ...
    clicks: int("clicks").default(0).notNull(),
    conversions: int("conversions").default(0).notNull(),
    totalRewardsEarned: decimal("total_rewards_earned", {
      precision: 18,
      scale: 8,
    }).default("0"),
    isActive: boolean("is_active").default(true).notNull(),
...
export const referralConversions = mysqlTable(
  ...
  t => ({
    referredUserIdx: uniqueIndex("referral_conversions_referred_user_idx").on(
      t.referredUserId
    ),
  })
);

export const dauEvents = mysqlTable(
  "dau_events",
  {
...
export const funnelEvents = mysqlTable(
  ...
  t => ({
    funnelStepIdx: index("funnel_events_funnel_step_idx").on(
      t.funnelId,
      t.step
    ),
...
export const cohorts = mysqlTable(
  "cohorts",
  {
    ...
    retentionData: json("retention_data")
...
export const userSubscriptions = mysqlTable(
  "user_subscriptions",
  {
    id: varchar("id", { length: 64 }).primaryKey(),
    userId: int("user_id").notNull(),
    creatorId: int("user_id"), // Legacy alias for userId
    subscriberId: int("user_id").notNull(), // Legacy alias
...
export const platformFeeEvents = mysqlTable(
  "platform_fee_events",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
...
export const adImpressions = mysqlTable(
  "ad_impressions",
  {
    ...
    userId: int("user_id"),
    impressionType: varchar("impression_type", { length: 32 })
      .default("view")
      .notNull(),
    revenue: decimal("revenue", { precision: 10, scale: 6 }).notNull(),
    publisherShare: decimal("publisher_share", {
      precision: 10,
      scale: 6,
    }).notNull(),
    createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const commissionRecords = mysqlTable(
  "commission_records",
  {
    id: int("id").autoincrement().primaryKey(),
    affiliateLinkId: int("affiliate_link_id").notNull(),
...
export const websocketSessions = mysqlTable(
  "websocket_sessions",
  {
...
export const behaviorEvents = mysqlTable(
  "behavior_events",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
    userId: int("user_id").notNull(),
...
export const engagementMetrics = mysqlTable(
  "engagement_metrics",
  {
    id: int("id").autoincrement().primaryKey(),
  ...
  t => ({
    entityDateIdx: uniqueIndex("engagement_metrics_entity_date_idx").on(
      t.entityType,
      t.entityId,
      t.date
    ),
...
export const systemAnalytics = mysqlTable(
  "system_analytics",
  {
    id: int("id").autoincrement().primaryKey(),
...
export const aiInferenceLog = mysqlTable(
  "ai_inference_log",
  {
    id: bigint("id", { mode: "number" }).autoincrement().primaryKey(),
...
export const moderationDecisions = mysqlTable(
  ...
  t => ({
    contentIdx: index("moderation_decisions_content_idx").on(
      t.contentType,
      t.contentId
    ),
...
export const rateLimitViolations = mysqlTable(
  ...
  t => ({
    identifierIdx: index("rate_limit_violations_identifier_idx").on(
      t.identifier
    ),
...
export const mediaAssets = mysqlTable(
  "media_assets",
  {
    ...
    status: varchar("status", { length: 32 }).default("pending").notNull(),
    moderationStatus: varchar("moderation_status", { length: 32 }).default(
      "pending"
    ),
...
export const videoTranscodeJobs = mysqlTable(
  "video_transcode_jobs",
  {
    ...
    qualityVariants: json("quality_variants")
      .$type<Array<{ quality: string; url: string; bitrate: number }>>()
      .default([]),
...
// ─── COMMANDMENT 11: AUTONOMOUS SPRINT ENGINE ──────────────────────────────

export const codebaseSprints = mysqlTable("codebase_sprints", {
  id: int("id").autoincrement().primaryKey(),
  sprintNumber: int("sprint_number").notNull(),
  scheduleCronTaskUid: varchar("schedule_cron_task_uid", { length: 65 }),
  status: varchar("status", { length: 32 }).default("scheduled").notNull(), // scheduled, running, completed, failed
  totalLinesAdded: int("total_lines_added").default(0).notNull(),
  totalFilesModified: int("total_files_modified").default(0).notNull(),
  languagesUsed: json("languages_used"),
  botsActivated: json("bots_activated"),
  featuresBuilt: json("features_built"),
  testsAdded: int("tests_added").default(0).notNull(),
  securityIssuesFixed: int("security_issues_fixed").default(0).notNull(),
  performanceGainPct: decimal("performance_gain_pct", {
    precision: 5,
    scale: 2,
  }).default("0"),
  startedAt: timestamp("started_at"),
...
export const sprintTasks = mysqlTable("sprint_tasks", {
  ...
  botId: varchar("bot_id", { length: 20 }).notNull(),
  taskType: varchar("task_type", { length: 50 }).notNull(),
  language: varchar("language", { length: 20 }).notNull(),
  description: text("description").notNull(),
  linesGenerated: int("lines_generated").default(0).notNull(),
  status: varchar("status", { length: 32 }).default("pending").notNull(), // pending, running, done, failed
  output: text("output"),
  startedAt: timestamp("started_at"),
  completedAt: timestamp("completed_at"),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const sprintMetrics = mysqlTable("sprint_metrics", {
  ...
  totalLines: int("total_lines").default(0).notNull(),
  tsLines: int("ts_lines").default(0).notNull(),
  solidityLines: int("solidity_lines").default(0).notNull(),
  rustLines: int("rust_lines").default(0).notNull(),
  pythonLines: int("python_lines").default(0).notNull(),
  sqlLines: int("sql_lines").default(0).notNull(),
  shellLines: int("shell_lines").default(0).notNull(),
  testCoverage: decimal("test_coverage", { precision: 5, scale: 2 }).default(
    "0"
  ),
  sprintsCompleted: int("sprints_completed").default(0).notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});
