...
export async function hasFeatureAccess(
  ...
  if (!subscription.length) {
    return (
      SUBSCRIPTION_TIERS.free.features[
        feature as keyof typeof SUBSCRIPTION_TIERS.free.features
      ] === true
    );
  }
  ...
  return (
    tierFeatures.features[feature as keyof typeof tierFeatures.features] ===
    true
  );
}
...
export async function checkDailyLimit(
  ...
  const limit =
    limitType === "likes"
      ? tierData.features.dailyLikes
      : tierData.features.dailySuperLikes;
