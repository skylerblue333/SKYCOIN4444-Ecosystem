...
export type PlatformEventType =
  ...
  | "AI_GOAL_ADJUSTED"
  | "AI_ACTION_INITIATED"
  | "SELF_OPTIMIZE_TRIGGERED"
  | "RULE_ADJUSTED"
  | "LOW_LIQUIDITY_DETECTED"
  | "RETENTION_DROPPING"
  | "FRAUD_SPIKE_DETECTED"
  | "INFLATION_WARNING"
  | "EMERGENT_SINK_CREATED"
  | "DIGITAL_NATION_EVENT"
  | "WALLET_CREATED"
  | "TRANSACTION_SIGNED"
    ...
    try {
      ...
      await db.insert(auditLedger).values(
        batch.map(e => ({
          ...
          eventType: e.type,
          action: e.type,
          userId: e.userId == null ? null : String(e.userId),
          details: JSON.stringify(e.payload, (_key, value) =>
