...
// ═══════════════════════════════════════════════════════════════
export const EXTENDED_BOT_DEFINITIONS: Record<
  ExtendedBotId,
  ExtendedBotDefinition
> = {
  FLUX: {
    id: "FLUX",
    name: "FLUX",
    ...
    description:
      "Builds WebSocket servers, SSE streams, Redis pub/sub, and live notification pipelines",
...
For SKYCOIN4444: build live feed updates, real-time notifications, live stream chat, live price tickers, and live gifting systems.`,
  ...
  KARMA: {
    ...
    description:
      "Designs and implements social trust scores, reputation algorithms, and anti-gaming systems",
...
Always expose reputation scores via tRPC with detailed breakdowns users can understand.`,
  ...
  MINT: {
    ...
    description:
      "Handles NFT minting, IPFS metadata storage, royalty contracts, and marketplace integration",
...
Always include: lazy minting, batch minting, metadata reveal mechanics, and royalty enforcement.`,
  ...
  SURGE: {
    ...
    description:
      "Designs yield farming strategies, liquidity pool analytics, and auto-compounding vaults",
...
Always calculate: real APY (not APR), impermanent loss risk, gas cost impact on returns.`,
  ...
  GHOST: {
    ...
    description:
      "Implements end-to-end encryption, zero-knowledge proofs, and privacy-preserving protocols",
...
Always use: Web Crypto API on frontend, Node.js crypto on backend, never roll your own crypto primitives.`,
  ...
  PIXEL: {
    ...
    description:
      "Handles image optimization, video transcoding, thumbnail generation, and CDN pipelines",
...
Always implement: format detection, size limits, malware scanning hooks, and progressive enhancement.`,
  ...
  HERALD: {
    ...
    description:
      "Builds SEO systems, growth loops, referral mechanics, and viral coefficient optimizers",
...
Always measure: viral coefficient, referral conversion rate, LTV/CAC ratio, and payback period.`,
  ...
  LEDGER: {
    ...
    description:
      "Builds treasury management, revenue accounting, payout systems, and financial reporting",
...
Always implement: immutable transaction logs, reconciliation checks, and audit-ready reporting.`,
  ...
  SCOUT: {
    ...
    description:
      "Builds web scrapers, price feed aggregators, on-chain data indexers, and market data pipelines",
...
Always implement: rate limiting, fallback sources, data validation, and stale data detection.`,
  ...
  VORTEX: {
    ...
    description:
      "Builds full-text search, semantic search, content indexing, and recommendation engines",
...
Always implement: search analytics, zero-result tracking, query suggestions, and search result explanations.`,
  ...
  EMBER: {
    ...
    description:
      "Builds email drip campaigns, transactional emails, push notifications, and engagement automation",
...
Always implement: unsubscribe handling, bounce management, open/click tracking, and CAN-SPAM compliance.`,
  ...
  QUILL: {
    ...
    description:
      "Generates blog posts, whitepapers, social content, and platform documentation using LLM",
...
Always write: accurate, fact-checked content that builds trust and drives organic growth.`,
  ...
  SAGE: {
    ...
    description:
      "Builds FAQ systems, help centers, AI support chatbots, and self-service resolution flows",
...
Always implement: feedback loops to improve answers, escalation to human support, and knowledge gap detection.`,
  ...
  PRAXIS: {
    ...
    description:
      "Runs A/B tests, heatmap analysis, funnel optimization, and user journey mapping",
...
Always measure: statistical significance (p < 0.05), effect size, confidence intervals, and business impact.`,
  ...
  RUNE: {
    ...
    description:
      "Audits Solidity contracts for vulnerabilities, gas optimization, and formal verification",
...
Always provide: severity ratings (Critical/High/Medium/Low), proof-of-concept exploits, and remediation code.`,
  ...
  HYDRA: {
    ...
    description:
      "Builds cross-chain bridges, multi-chain wallets, and interoperability protocols",
...
Always implement: bridge security checks, slippage protection, failed transaction recovery, and audit trails.`,
  ...
  LUMEN: {
    ...
    description:
      "Builds interactive charts, real-time dashboards, and data storytelling components",
...
Always implement: responsive sizing, dark/light theme support, loading states, and interactive tooltips.`,
  ...
  STORM: {
    ...
    description:
      "Runs load tests, chaos experiments, and builds resilience patterns for production systems",
...
Always measure: p50/p95/p99 latency, error rate under load, recovery time, and capacity limits.`,
  ...
  AXIOM: {
    ...
    description:
      "Models token economics, simulates market dynamics, and validates protocol incentive structures",
...
Always validate: incentive alignment, attack vectors (whale manipulation, governance attacks), and long-term sustainability.`,
  ...
  CIPHER2: {
    ...
    description:
      "Implements HSM integration, key rotation, threshold signatures, and MPC protocols",
...
Always implement: key rotation schedules, access audit logs, emergency recovery procedures, and defense in depth.`,
  ...
  NEXUS2: {
    ...
    description:
      "Designs federated GraphQL schemas, subscriptions, and API gateway patterns",
...
Always implement: query complexity limits, depth limiting, rate limiting per query, and introspection controls.`,
  ...
  DELTA: {
    ...
    description:
      "Handles schema migrations, data transformations, ETL pipelines, and database optimization",
...
Always implement: migration testing in staging, rollback procedures, data validation checks, and performance benchmarks.`,
  ...
  OMEGA: {
    ...
    description:
      "Designs system architecture, service mesh, event-driven patterns, and platform scalability",
...
Always consider: data consistency (eventual vs strong), service boundaries, failure isolation, and operational complexity.`,
  ...
  ZENITH: {
    ...
    description:
      "Builds creator monetization systems, subscription mechanics, tip flows, and revenue analytics",
...
Always optimize: creator LTV, subscriber retention, tip conversion rate, and platform revenue share.`,
  ...
  AURA: {
    ...
    description:
      "Builds AI moderation systems, community health metrics, and automated enforcement",
...
Always implement: human review for edge cases, bias auditing, false positive tracking, and transparent enforcement.`,
  ...
  BLAZE: {
    ...
    description:
      "Optimizes mobile UX, builds PWA features, and implements native mobile patterns",
    color: "oklch(0.72 0.24 20)",
    icon: "📱",
    category: "Mobile",
    priority: "high",
...
Always test: on real devices (iOS/Android), with slow network, and with accessibility tools.`,
  ...
  CORE: {
    ...
    description:
      "Designs core platform architecture, API contracts, and system-wide patterns",
    color: "oklch(0.72 0.16 200)",
    icon: "⚙️",
    category: "Infrastructure",
    priority: "critical",
...
Always document: architectural decisions (ADRs), trade-offs, migration paths, and technical debt.`,
  ...
  DRIFT: {
    ...
    description:
      "Builds feature flag systems, gradual rollouts, kill switches, and experimentation platforms",
...
Always implement: flag cleanup processes, audit logs, emergency kill switches, and experiment guardrails.`,
  ...
  ECHO2: {
    ...
    description:
      "Handles audio transcription, podcast hosting, voice cloning, and audio content pipelines",
    color: "oklch(0.72 0.18 280)",
    icon: "🎙️",
    category: "Media",
    priority: "medium",
...
Always implement: audio compression, format conversion (MP3/AAC/OGG), waveform visualization, and playback analytics.`,
  ...
  FUSE: {
    ...
    description:
      "Builds third-party integrations, webhook systems, OAuth flows, and API connectors",
...
Always implement: idempotency keys, exponential backoff, dead letter queues, and webhook security.`,
  ...
  GRID: {
    ...
    description:
      "Optimizes cloud infrastructure, reduces costs, and builds auto-scaling systems",
...
Always measure: cost per user, infrastructure utilization, scaling efficiency, and SLA compliance.`,
  ...
  HALO: {
    ...
    description:
      "Audits AI systems for bias, hallucinations, safety violations, and alignment issues",
  ...
  for (let i = 0; i < params.assignments.length; i += maxParallel) {
    ...
    const batchResults = await Promise.allSettled(
      batch.map(async assignment => {
        const isExtended = Object.keys(EXTENDED_BOT_DEFINITIONS).includes(
          assignment.agentId
        );
        if (isExtended) {
          ...
          const response = await llm({
            messages: [
              {
                role: "system",
                content: `You are ${assignment.agentId}, an AI coding specialist for SKYCOIN4444. Generate production-ready ${assignment.language} code.`,
              },
          ...
          return {
            code,
            explanation: "Generated by " + assignment.agentId,
