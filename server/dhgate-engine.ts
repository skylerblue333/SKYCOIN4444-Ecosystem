...
export const DHGATE_PRODUCTS: DHgateProduct[] = [
  ...
  {
    id: "bag-001",
    dhgateId: "dh-bag-lv-001",
    title: "Designer Tote Bag — Premium Canvas",
    brand: "LuxeCarry",
    category: "bags",
    subcategory: "tote",
    description:
      "Premium quality canvas tote bag with leather trim. Spacious interior with multiple compartments. Perfect for daily use or travel. Ships from verified DHgate supplier.",
    price: 18.5,
    platformPrice: 26.85,
    adminFee: 8.14,
    adminFeePercent: 44,
    ...
    tags: ["tote", "canvas", "designer", "luxury", "women"],
    sizes: ["One Size"],
  ...
  {
    id: "bag-002",
    dhgateId: "dh-bag-chanel-001",
    title: "Classic Quilted Shoulder Bag",
    brand: "ChicMode",
    category: "bags",
    subcategory: "shoulder",
    description:
      "Iconic quilted design with chain strap. Gold-tone hardware. Genuine PU leather. Multiple interior pockets.",
    price: 24.0,
    platformPrice: 34.8,
    adminFee: 10.56,
    adminFeePercent: 44,
    ...
    tags: ["shoulder", "quilted", "chain", "classic", "women"],
  ...
  {
    id: "bag-003",
    dhgateId: "dh-bag-backpack-001",
    title: "Urban Tactical Backpack 30L",
    brand: "UrbanGear",
    category: "bags",
    subcategory: "backpack",
    description:
      "Military-style tactical backpack with MOLLE system. USB charging port. Waterproof material. 30L capacity.",
    price: 22.0,
    platformPrice: 31.9,
    adminFee: 9.68,
    adminFeePercent: 44,
    ...
    tags: ["backpack", "tactical", "urban", "travel", "men"],
  ...
  {
    id: "watch-001",
    dhgateId: "dh-watch-rolex-001",
    title: "Luxury Automatic Dress Watch",
    brand: "TimeMaster",
    category: "watches",
    subcategory: "automatic",
    description:
      "Stainless steel case with sapphire crystal glass. Automatic movement. Date display. Water resistant to 30m. Oyster-style bracelet.",
    price: 45.0,
    platformPrice: 65.25,
    adminFee: 19.8,
    adminFeePercent: 44,
  ...
  {
    id: "watch-002",
    dhgateId: "dh-watch-ap-001",
    title: "Royal Oak Style Sport Watch",
    brand: "ApexTime",
    category: "watches",
    subcategory: "sport",
    description:
      "Octagonal bezel design. Integrated bracelet. Swiss-style quartz movement. Luminous hands. Scratch-resistant case.",
    price: 38.0,
    platformPrice: 55.1,
    adminFee: 16.72,
    adminFeePercent: 44,
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1587836374828-4dbafa94cf0e?w=300&q=80",
    rating: 4.7,
    reviewCount: 3210,
    soldCount: 18750,
    inStock: true,
    ...
    tags: ["watch", "sport", "luxury", "men", "quartz"],
  ...
  {
    id: "watch-003",
    dhgateId: "dh-watch-ladies-001",
    title: "Diamond-Studded Ladies Watch",
    brand: "GlamTime",
    category: "watches",
    subcategory: "ladies",
    description:
      "Elegant ladies watch with crystal-studded bezel. Rose gold plating. Genuine leather strap. Japanese quartz movement.",
    price: 28.0,
    platformPrice: 40.6,
    adminFee: 12.32,
    adminFeePercent: 44,
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1617043786394-f977fa12eddf?w=300&q=80",
    rating: 4.8,
    reviewCount: 2890,
    soldCount: 21400,
    inStock: true,
    ...
    tags: ["watch", "ladies", "diamond", "rose gold", "elegant"],
  ...
  {
    id: "shoe-001",
    dhgateId: "dh-shoe-jordan-001",
    title: "Air Retro High OG Sneakers",
    brand: "SkyKicks",
    category: "shoes",
    subcategory: "sneakers",
    description:
      "Premium quality retro basketball sneakers. Full-grain leather upper. Air cushioning unit. Rubber outsole with herringbone pattern.",
    price: 35.0,
    platformPrice: 50.75,
    adminFee: 15.4,
    adminFeePercent: 44,
  ...
  {
    id: "shoe-002",
    dhgateId: "dh-shoe-yeezy-001",
    title: "Boost 350 V2 Style Runners",
    brand: "FutureFoot",
    category: "shoes",
    subcategory: "running",
    description:
      "Primeknit upper with BOOST midsole technology. Stretchy knit construction. Rubber outsole. Lightweight and responsive.",
    price: 42.0,
    platformPrice: 60.9,
    adminFee: 18.48,
    adminFeePercent: 44,
  ...
  {
    id: "shoe-003",
    dhgateId: "dh-shoe-loafer-001",
    title: "Luxury Leather Loafers",
    brand: "EliteStep",
    category: "shoes",
    subcategory: "dress",
    description:
      "Genuine leather upper with hand-stitched moccasin toe. Rubber sole. Metal bit detail. Available in multiple colors.",
    price: 30.0,
    platformPrice: 43.5,
    adminFee: 13.2,
    adminFeePercent: 44,
  ...
  {
    id: "pants-001",
    dhgateId: "dh-pants-cargo-001",
    title: "Tactical Cargo Pants",
    brand: "UrbanTac",
    category: "pants",
    subcategory: "cargo",
    description:
      "Multi-pocket tactical cargo pants. Ripstop fabric. Adjustable waistband. Knee pad pockets. Available in multiple colors.",
    price: 19.5,
    platformPrice: 28.3,
    adminFee: 8.58,
    adminFeePercent: 44,
  ...
  {
    id: "pants-002",
    dhgateId: "dh-pants-jeans-001",
    title: "Slim Fit Designer Jeans",
    brand: "DenimLux",
    category: "pants",
    subcategory: "jeans",
    description:
      "Premium stretch denim. Slim fit silhouette. Distressed details. 5-pocket design. Authentic washed finish.",
    price: 22.0,
    platformPrice: 31.9,
    adminFee: 9.68,
    adminFeePercent: 44,
  ...
  {
    id: "shirt-001",
    dhgateId: "dh-shirt-polo-001",
    title: "Luxury Polo Shirt — Pique Cotton",
    brand: "ClassicPolo",
    category: "shirts",
    subcategory: "polo",
    description:
      "100% pique cotton polo. Embroidered logo detail. Ribbed collar and cuffs. Regular fit. Machine washable.",
    price: 12.5,
    platformPrice: 18.15,
    adminFee: 5.5,
    adminFeePercent: 44,
  ...
  {
    id: "shirt-002",
    dhgateId: "dh-shirt-hoodie-001",
    title: "Premium Oversized Hoodie",
    brand: "StreetLux",
    category: "shirts",
    subcategory: "hoodie",
    description:
      "400gsm heavyweight cotton blend. Oversized fit. Kangaroo pocket. Ribbed cuffs and hem. Embroidered logo.",
    price: 18.0,
    platformPrice: 26.1,
    adminFee: 7.92,
    adminFeePercent: 44,
  ...
  {
    id: "elec-001",
    dhgateId: "dh-elec-earbuds-001",
    title: "Pro Wireless Earbuds — ANC",
    brand: "SoundPro",
    category: "electronics",
    subcategory: "audio",
    description:
      "Active noise cancellation. 30hr battery life. IPX5 waterproof. Bluetooth 5.3. Touch controls. Hi-Fi sound with deep bass.",
    price: 28.0,
    platformPrice: 40.6,
    adminFee: 12.32,
    adminFeePercent: 44,
  ...
  {
    id: "elec-002",
    dhgateId: "dh-elec-smartwatch-001",
    title: "Smart Watch Pro — Health Monitor",
    brand: "TechWrist",
    category: "electronics",
    subcategory: "smartwatch",
    description:
      '1.96" AMOLED display. Heart rate + SpO2 + sleep tracking. GPS. 100+ sport modes. 7-day battery. IP68 waterproof.',
    price: 32.0,
    platformPrice: 46.4,
    adminFee: 14.08,
    adminFeePercent: 44,
  ...
  {
    id: "elec-003",
    dhgateId: "dh-elec-phone-001",
    title: "Mini Portable Projector 4K",
    brand: "CineMax",
    category: "electronics",
    subcategory: "projector",
    description:
      "Native 1080P with 4K support. 300 ANSI lumens. Built-in Android 11. WiFi + Bluetooth. Auto keystone correction. 3hr battery.",
    price: 65.0,
    platformPrice: 94.25,
    adminFee: 28.6,
    adminFeePercent: 44,
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1626379953822-baec19c3accd?w=300&q=80",
    rating: 4.5,
    reviewCount: 2340,
    soldCount: 14500,
    inStock: true,
  ...
  {
    id: "elec-004",
    dhgateId: "dh-elec-tablet-001",
    title: '10.1" Android Tablet — 8GB RAM',
    brand: "TabPro",
    category: "electronics",
    subcategory: "tablet",
    description:
      '10.1" IPS display. Octa-core processor. 8GB RAM + 256GB storage. 5G WiFi. 7000mAh battery. Dual cameras.',
    price: 78.0,
    platformPrice: 113.1,
    adminFee: 34.32,
    adminFeePercent: 44,
...
export const DHGATE_REVIEWS: DHgateReview[] = [
  ...
  },
  {
    ...
    body: "Really happy with this purchase. The leather trim is high quality and the stitching is solid. Docked one star because the zipper was slightly stiff at first but loosened up.",
    images: [],
    verified: true,
    helpful: 89,
    date: "2025-12-02",
  ...
  },
  {
    ...
    body: "Bought this as a gift for my dad and he absolutely loves it. The weight feels premium, the bracelet clasp is smooth. Highly recommend.",
    images: [],
    verified: true,
    helpful: 312,
    date: "2025-11-20",
  ...
  },
  {
    ...
    reviewer: "Kevin R.",
    rating: 4,
    title: "Great kicks, slight color difference",
    body: "Really happy overall. The quality is excellent. The colorway is slightly different from the photos but still looks great. Shipping took 18 days.",
    images: [],
    verified: true,
    helpful: 234,
    date: "2025-11-05",
...
export function getPlatformPrice(dhgateBasePrice: number): number {
  return (
    Math.round(dhgateBasePrice * (1 + ADMIN_FEE_PERCENT / 100) * 100) / 100
  );
}
...
export const DHGATE_CATEGORIES: Array<{
  id: ProductCategory;
  label: string;
  emoji: string;
  count: number;
}> = [
  {
    ...
    label: "Bags & Purses",
    emoji: "👜",
    count: DHGATE_PRODUCTS.filter(p => p.category === "bags").length,
  },
  {
    id: "watches",
    label: "Watches",
    emoji: "⌚",
    count: DHGATE_PRODUCTS.filter(p => p.category === "watches").length,
  },
  {
    id: "shoes",
    label: "Shoes & Sneakers",
    emoji: "👟",
    count: DHGATE_PRODUCTS.filter(p => p.category === "shoes").length,
  },
  {
    id: "pants",
    label: "Pants & Bottoms",
    emoji: "👖",
    count: DHGATE_PRODUCTS.filter(p => p.category === "pants").length,
  },
  {
    id: "shirts",
    label: "Shirts & Tops",
    emoji: "👕",
    count: DHGATE_PRODUCTS.filter(p => p.category === "shirts").length,
  },
  {
    id: "electronics",
    label: "Electronics",
    emoji: "📱",
    count: DHGATE_PRODUCTS.filter(p => p.category === "electronics").length,
  },
];
