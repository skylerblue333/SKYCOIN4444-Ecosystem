...
export class NarrativeEngine {
  ...
  async generateNarrative(
    ...
    const positioningStatement = this.generatePositioningStatement(
      featureName,
      context
    );
    const narrativeVariants = this.generateNarrativeVariants(
      featureName,
   ...
   */
  private generateNarrativeVariants(
    featureName: string,
    positioning: string
  ): NarrativeVariant[] {
    return [
      {
        ...
        subtitle:
          "Reduce operational costs by 40% while improving team productivity",
  ...
  async getPositioningStatement(
    ...
    const statements: Record<string, PositioningStatement> = {
      enterprise: {
        ...
        needStatement:
          "need to reduce operational costs while maintaining security and compliance",
      ...
      consumer: {
        ...
        differentiator:
          "Simple, beautiful, and works with tools you already use",
   ...
   */
  async checkNarrativeConsistency(
    narratives: NarrativeVariant[]
  ): Promise<any> {
    return {
