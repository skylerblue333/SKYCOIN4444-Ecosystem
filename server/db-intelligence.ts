...
export async function getUserActivitySignals(userId: string) {
  ...
  // These legacy score dimensions no longer exist as duplicated columns on
  // users. Keep them explicit and neutral here; the reputation score itself is
  // persisted in reputation_scores below.
