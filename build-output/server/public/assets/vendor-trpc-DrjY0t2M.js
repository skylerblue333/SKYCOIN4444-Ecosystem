...
const oe = typeof Symbol == "function" && !!Symbol.asyncIterator;
function nt(t) {
  return oe && j(t) && Symbol.asyncIterator in t;
}
var ie = Object.create,
  ...
  S = (t, e) =>
    function () {
      return (
        e || (0, t[J(t)[0]])((e = { exports: {} }).exports, e),
        e.exports
      );
    },
  ce = (t, e, r, o) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (var n = J(e), i = 0, u = n.length, s; i < u; i++)
        ((s = n[i]),
          !ae.call(t, s) &&
            s !== r &&
            H(t, s, {
              get: (a => e[a]).bind(null, s),
              enumerable: !(o = se(e, s)) || o.enumerable,
            }));
    return t;
  },
  q = (t, e, r) => (
    (r = t != null ? ie(ue(t)) : {}),
    ce(H(r, "default", { value: t, enumerable: !0 }), t)
  );
const F = () => {},
  G = t => {
        ...
        apply(i, u, s) {
          ...
          return (
            a === "call"
              ...
              : a === "apply" &&
                (c = { args: s.length >= 2 ? s[1] : [], path: e.slice(0, -1) }),
            G(c.args),
            G(c.path),
            t(c)
          );
...
const le = t => Y(t, [], Object.create(null)),
  pe = t =>
    new Proxy(F, {
      get(e, r) {
        if (r !== "then") return t(r);
      },
    });
var $ = S({
...
function ve(t, e) {
  ...
  if (!r.ok && (!j(r.error.error) || typeof r.error.error.code != "number"))
    throw new L();
  if (r.ok && !j(r.result)) throw new L();
  return r;
}
q(D());
function M(t) {
      ...
      return (
        (o = t({
          ...
          error(a) {
            ...
            n ||
              ((n = !0),
              (c = r.error) === null || c === void 0 || c.call(r, a),
              s());
          },
          complete() {
            var a;
...
var he = Object.create,
  ...
  P = (t, e) =>
    function () {
      return (
        e || (0, t[V(t)[0]])((e = { exports: {} }).exports, e),
        e.exports
      );
    },
  ge = (t, e, r, o) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (var n = V(e), i = 0, u = n.length, s; i < u; i++)
        ((s = n[i]),
          !_e.call(t, s) &&
            s !== r &&
            Q(t, s, {
              get: (a => e[a]).bind(null, s),
              enumerable: !(o = xe(e, s)) || o.enumerable,
            }));
    return t;
  },
  v = (t, e, r) => (
...
function Ce(t, e) {
  return typeof t == "string"
    ? t
    : j(t) && typeof t.message == "string"
      ? t.message
      : e;
}
var A = class k extends Error {
  constructor(e, r) {
    var o, n;
    const i = r?.cause;
    (super(e, { cause: i }),
      (0, I.default)(this, "cause", void 0),
      (0, I.default)(this, "shape", void 0),
      (0, I.default)(this, "data", void 0),
      (0, I.default)(this, "meta", void 0),
      (this.meta = r?.meta),
      (this.cause = i),
      (this.shape =
        r == null || (o = r.result) === null || o === void 0
          ? void 0
          : o.error),
      (this.data =
  ...
  static from(e, r = {}) {
    ...
    return Te(o)
      ? (r.meta &&
          (o.meta = (0, w.default)((0, w.default)({}, o.meta), r.meta)),
        o)
      : Ie(o)
        ? new k(
            o.error.message,
            (0, w.default)((0, w.default)({}, r), {}, { result: o })
          )
        : new k(
            Ce(o, "Unknown error"),
            (0, w.default)((0, w.default)({}, r), {}, { cause: o })
          );
  }
};
function ke(t) {
...
const W = t => typeof t == "function";
function Ae(t) {
  if (t) return t;
  if (typeof window < "u" && W(window.fetch)) return window.fetch;
  if (typeof globalThis < "u" && W(globalThis.fetch)) return globalThis.fetch;
...
const Le = { query: "GET", mutation: "POST", subscription: "PATCH" };
function Z(t) {
  return "input" in t
    ? t.transformer.input.serialize(t.input)
    : Me(t.inputs.map(e => t.transformer.input.serialize(e)));
}
const ee = t => {
    const e = t.url.split("?");
  ...
  Re = t =>
    Ke(
      (0, O.default)(
        (0, O.default)({}, t),
        {},
        { contentTypeHeader: "application/json", getUrl: ee, getBody: Ne }
      )
    );
...
const Ge = t => {
  ...
  if (t?.aborted)
    throw (
      (e = t.throwIfAborted) === null || e === void 0 || e.call(t),
...
async function We(t) {
  ...
  const r = t.getUrl(t),
    o = t.getBody(t),
    n = (e = t.methodOverride) !== null && e !== void 0 ? e : Le[t.type],
    i = await (async () => {
    ...
    u = (0, O.default)(
      (0, O.default)(
        (0, O.default)(
          {},
          t.contentTypeHeader && n !== "GET"
            ? { "content-type": t.contentTypeHeader }
            : {}
        ),
        t.trpcAcceptHeader ? { "trpc-accept": t.trpcAcceptHeader } : void 0
      ),
      i
    );
  return Ae(t.fetch)(r, { method: n, signal: t.signal, body: o, headers: u });
}
async function Ke(t) {
  const e = {},
    r = await We(t);
  ...
  return ((e.responseJSON = o), { json: o, meta: e });
}
v(x(), 1);
const K = () => {
  throw new Error(
...
function U(t) {
  ...
  function n(s) {
    ...
    for (;;) {
      ...
      if (f.length === 0) {
        ...
        ((l = d.reject) === null ||
          l === void 0 ||
          l.call(d, new Error("Input is too big for a single dispatch")),
          c++);
        continue;
      }
      a.push([]);
      ...
      t.fetch(c.items.map(l => l.key))
        .then(async l => {
          ...
          for (const f of c.items) {
            ...
            ((d = f.reject) === null ||
              d === void 0 ||
              d.call(f, new Error("Missing result")),
              (f.batch = null));
          }
        })
        .catch(l => {
          for (const f of c.items) {
            var d;
            ((d = f.reject) === null || d === void 0 || d.call(f, l),
              (f.batch = null));
          }
        });
    }
  ...
  function u(s) {
    var a;
    const c = { aborted: !1, key: s, batch: null, resolve: K, reject: K },
      y = new Promise((l, d) => {
        var f;
        ((c.reject = d),
          (c.resolve = l),
    ...
    return (((a = r) !== null && a !== void 0) || (r = setTimeout(i)), y);
  }
  return { load: u };
}
function Ue(...t) {
...
function ot(t) {
  var e, r;
  const o = qe(t),
    n = (e = t.maxURLLength) !== null && e !== void 0 ? e : 1 / 0,
    i = (r = t.maxItems) !== null && r !== void 0 ? r : 1 / 0;
  return () => {
    const u = y => ({
        validate(l) {
          if (n === 1 / 0 && i === 1 / 0) return !0;
          if (l.length > i) return !1;
          const d = l.map(p => p.path).join(","),
            f = l.map(p => p.input);
          return (
            ee(
              (0, C.default)(
                (0, C.default)({}, o),
                {},
                { type: y, path: d, inputs: f, signal: null }
              )
            ).length <= n
          );
        },
        async fetch(l) {
          const d = l.map(h => h.path).join(","),
            f = l.map(h => h.input),
            m = Ue(...l.map(h => h.signal)),
            p = await Re(
              (0, C.default)(
                (0, C.default)({}, o),
                {},
          ...
          return (Array.isArray(p.json) ? p.json : l.map(() => p.json)).map(
            h => ({ meta: p.meta, json: h })
          );
        },
      }),
      s = U(u("query")),
      a = U(u("mutation")),
      c = { query: s, mutation: a };
    return ({ op: y }) =>
      M(l => {
        /* istanbul ignore if -- @preserve */ if (y.type === "subscription")
          throw new Error(
            "Subscriptions are unsupported by `httpLink` - use `httpSubscriptionLink` or `wsLink`"
          );
        const f = c[y.type].load(y);
        let m;
        return (
          f
            .then(p => {
              m = p;
              const b = ve(p.json, o.transformer.output);
              if (!b.ok) {
                l.error(A.from(b.error, { meta: p.meta }));
                return;
              }
              (l.next({ context: p.meta, result: b.result }), l.complete());
            })
            .catch(p => {
              l.error(A.from(p, { meta: m?.meta }));
            }),
          () => {}
        );
      });
...
async function Je(t) {
  const e = { method: "connectionParams", data: await te(t) };
...
function Ye(t, { intervalMs: e, pongTimeoutMs: r }) {
  let o, n;
  function i() {
    o = setTimeout(() => {
      (t.send("PING"),
  ...
  (t.addEventListener("open", i),
    t.addEventListener("message", ({ data: a }) => {
...
var $e = class R {
  constructor(e) {
    var r;
    if (
      ((0, _.default)(this, "id", ++R.connectCount),
      (0, _.default)(this, "WebSocketPonyfill", void 0),
      (0, _.default)(this, "urlOptions", void 0),
      (0, _.default)(this, "keepAliveOpts", void 0),
      (0, _.default)(this, "wsObservable", Se(null)),
      (0, _.default)(this, "openPromise", null),
      (this.WebSocketPonyfill =
        (r = e.WebSocketPonyfill) !== null && r !== void 0 ? r : WebSocket),
      !this.WebSocketPonyfill)
    )
      throw new Error(
  ...
  async open() {
    ...
    e.openPromise = r.then(async o => {
      ((e.ws = o),
        o.addEventListener("message", function ({ data: n }) {
          n === "PING" && this.send("PONG");
        }),
        e.keepAliveOpts.enabled && Ye(o, e.keepAliveOpts),
        o.addEventListener("close", () => {
          e.ws === o && (e.ws = null);
        }),
        await Fe(o),
        e.urlOptions.connectionParams &&
          o.send(await Je(e.urlOptions.connectionParams)));
    });
    try {
      await e.openPromise;
    } finally {
...
var N = v(g(), 1),
  ...
  Be = class {
    constructor(t) {
      ((0, N.default)(this, "links", void 0),
        (0, N.default)(this, "runtime", void 0),
        (0, N.default)(this, "requestId", void 0),
        (this.requestId = 0),
        (this.runtime = {}),
        (this.links = t.links.map(e => e(this.runtime))));
    }
    $request(t) {
      var e;
      return Ee({
...
const re = Symbol.for("trpc_untypedClient"),
  Qe = { query: "query", mutate: "mutation", subscribe: "subscription" },
  Ve = t => Qe[t];
function Xe(t) {
  const e = le(({ path: r, args: o }) => {
    const n = [...r],
      i = Ve(n.pop()),
      u = n.join(".");
    return t[i](u, ...o);
  });
  return pe(r => (r === re ? t : e[r]));
}
function it(t) {
  const e = new Be(t);
  return Xe(e);
...
var Ze = P({
  "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/asyncIterator.js"(
    ...
    function r(n) {
      ...
      for (
        typeof Symbol < "u" &&
        ((u = Symbol.asyncIterator), (s = Symbol.iterator));
        a--;
      ) {
      ...
      return (
        ...
        (o.prototype = {
          ...
          return: function (s) {
            var a = this.s.return;
            return a === void 0
              ? Promise.resolve({ value: s, done: !0 })
      ...
      function r() {
        ...
        function u(s, a) {
          if (a != null) {
            ...
            if (
              c === void 0 &&
              ((c = a[Symbol.dispose || Symbol.for("Symbol.dispose")]), s)
            )
              var y = c;
          ...
          d: function () {
            ...
            function l() {
              for (; (a = i.pop());)
                try {
                  if (!a.a && y === 1)
                    return ((y = 0), i.push(a), Promise.resolve().then(l));
                  if (a.d) {
                    var f = a.d.call(a.v);
                    if (a.a) return ((y |= 2), Promise.resolve(f).then(l, d));
                  } else y |= 1;
                } catch (m) {
                  return d(m);
                }
    ...
    "../../node_modules/.pnpm/@oxc-project+runtime@0.72.2/node_modules/@oxc-project/runtime/src/helpers/wrapAsyncGenerator.js"(
      ...
      function n(i) {
        ...
        function a(y, l) {
          try {
            var d = i[y](l),
              f = d.value,
              m = f instanceof r;
            Promise.resolve(m ? f.v : f).then(
              function (p) {
                if (m) {
                  var b = y === "return" ? "return" : "next";
        ...
        function c(y, l) {
          switch (y) {
            case "return":
              u.resolve({ value: l, done: !0 });
              break;
            case "throw":
              u.reject(l);
              break;
            default:
              u.resolve({ value: l, done: !1 });
          }
          (u = u.next) ? a(u.key, u.arg) : (s = null);
        }
        ((this._invoke = function (y, l) {
          return new Promise(function (d, f) {
            var m = { key: y, arg: l, resolve: d, reject: f, next: null };
            s ? (s = s.next = m) : ((u = s = m), a(y, l));
          });
        }),
