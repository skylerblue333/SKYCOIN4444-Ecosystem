...
export function AchievementToastContainer() {
  ...
  const addToast = useCallback((achievement: Achievement) => {
    ...
    setTimeout(() => {
      setToasts(prev =>
        prev.map(t => (t.toastId === toastId ? { ...t, visible: true } : t))
      );
    }, 50);
            ...
            <div className="p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <span
                    className={`text-xs px-2 py-0.5 rounded-full font-medium ${cfg.badge} flex items-center gap-1`}
                  >
                    <RarityIcon className="w-3 h-3" />
                    {cfg.label}
                  </span>
                  <span className="text-xs text-amber-400 font-bold flex items-center gap-1">
                    <Zap className="w-3 h-3" />+{toast.xpReward} XP
                  </span>
                </div>
              </div>
            </div>
...
export const SAMPLE_ACHIEVEMENTS: Achievement[] = [
  {
    id: "first_post",
    title: "First Post!",
    description: "You made your first post on SKYCOIN4444",
    icon: "✍️",
    xpReward: 100,
    rarity: "common",
  },
  {
    id: "first_stake",
    title: "Staker",
    description: "You staked SKY444 tokens for the first time",
    icon: "💎",
    xpReward: 250,
    rarity: "rare",
  },
  ...
  },
  {
    ...
    description: "Participated in the ICO",
    icon: "🚀",
    xpReward: 1000,
    rarity: "epic",
  },
  {
    id: "whale",
    title: "Whale Alert",
    description: "Held 10,000+ SKY444 tokens",
    icon: "🐋",
    xpReward: 2500,
    rarity: "legendary",
  },
  {
    ...
    description: "Donated to a charity campaign",
    icon: "❤️",
    xpReward: 300,
    rarity: "rare",
  },
  ...
  },
  {
    id: "course_complete",
    title: "Scholar",
    description: "Completed your first SkySchool course",
    icon: "🎓",
    xpReward: 750,
    rarity: "epic",
  },
