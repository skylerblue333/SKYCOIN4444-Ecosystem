  ...
  return (
    <div className="space-y-5">
      <div className="flex justify-center">
        <div
          className={`w-28 h-28 rounded-full flex items-center justify-center font-display font-black text-4xl border-4 ${
            result === null
      ...
      {msg && (
        <div className="text-center font-heading font-bold text-lg neon-text">
          {msg}
        </div>
      )}
      <div className="flex justify-center">
