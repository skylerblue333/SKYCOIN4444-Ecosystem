      ...
      setSnake(prev => {
        ...
        if (
          ...
          if (!endedRef.current) {
            ...
            onEnd(score * 10, `Game over — score ${score}`);
          }
          return prev;
        }
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="text-sm text-muted-foreground">
        Score:{" "}
        <span className="text-[var(--neon-cyan)] font-bold">{score}</span> · Use
        arrow keys
      </div>
      <div
        className="relative grid-bg rounded-lg border border-border"
