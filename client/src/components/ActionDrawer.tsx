...
export function ActionDrawer({
  ...
  const [step, setStep] = useState<"select" | "confirm" | "done">(
    preselectedIntent && preselectedIntent.type !== ACTION_TYPES.PLAIN_TEXT
      ? "confirm"
      : "select"
  );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-secondary/30 rounded-xl px-3 py-2.5 text-sm outline-none"
              />
            </div>
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={sendTx.isPending || !amount}
              ...
              >
                {sendTx.isPending
                  ? "Sending..."
                  : `Confirm ${getActionLabel(activeAction!)}`}
              </button>
            </div>
          </div>
        )}
