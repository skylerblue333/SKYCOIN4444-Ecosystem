      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Manage your courses, track student progress, and grow your revenue
          </p>
        </div>
          ...
          <TabsContent value="courses" className="mt-8 space-y-6">
            ...
            <div className="grid gap-4">
              {courses.map(course => (
                <Card
                  key={course.id}
                  className="bg-slate-900/50 border border-white/10 hover:border-cyan-500/50 transition-all"
                >
