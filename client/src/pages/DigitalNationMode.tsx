...
function TierCard({
  ...
  tier: (typeof CITIZENSHIP_TIERS)[0];
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              {
                label: "Active Zones",
                value: NATION_ZONES.filter(z => z.status === "active").length,
                icon: Map,
                color: "text-emerald-400",
              },
              {
                label: "Proposals Active",
                value: (governance?.activeProposals as number) ?? 0,
                icon: Gavel,
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            background: ZONE_COLORS[zone.type] ?? "#888",
                          }}
                        />
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            ...
                            <Badge
                              className={`text-[10px] ${zone.status === "active" ? "bg-emerald-500/10 text-emerald-400 border-emerald-500/30" : "bg-blue-500/10 text-blue-400 border-blue-500/30"}`}
                            >
                              {zone.status}
                            </Badge>
                          </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-1">
                    Ratified by token holder vote. Amendments require 75%
                    supermajority + 30-day deliberation. HOPE AI may propose
                    amendments but cannot ratify them unilaterally.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-violet-500/10 border border-violet-500/30 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mt-1">
                    HOPE AI analyzes platform data and autonomously proposes
                    governance improvements. All AI-proposed laws require human
                    ratification before taking effect.
                  </p>
                </div>
              </div>
                  ...
                  <CardContent className="p-5">
                    ...
                    {law.status === "proposed" && (
                      <div className="flex gap-2 mt-3">
                        <Button
                          size="sm"
                          className="bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 border border-emerald-500/30 text-xs"
                        >
                          Support
                        </Button>
                        <Button
