...
const PLATFORMS = [
  ...
  { id: "twitter", label: "Share2/X", icon: "𝕏", color: "blue" },
  { id: "instagram", label: "Camera", icon: "📸", color: "pink" },
              ...
              {queue.length === 0 ? (
                ...
                queue.map(post => {
                  ...
                  return (
                    <Card
                      key={post.id}
                      className="bg-black/40 border-white/10 hover:border-white/20 transition-colors"
                    >
                            ...
                            <div className="flex items-center gap-4 mt-2 text-xs text-gray-500">
                              ...
                              {post.engagement !== undefined && (
                                <span className="flex items-center gap-1 text-blue-400">
                                  <Zap className="w-3 h-3" /> {post.engagement}{" "}
                                  engagements
                                </span>
                              )}
                            </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex justify-between mt-1">
                    ...
                    <span className="text-xs text-gray-500">
                      {content.split(" ").filter(w => w.startsWith("#")).length}{" "}
                      hashtags
                    </span>
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  <p className="text-xs text-blue-300 flex items-center gap-2">
                    ...
                    <strong>Best times to post:</strong> 9AM, 12PM, 7PM EST —
                        ...
                        <div className="flex-1">
                          ...
                          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min(100, (count / Math.max(1, queue.length)) * 100)}%`,
                              }}
                            />
                          </div>
                        </div>
