...
export default function ComplianceCenter() {
  ...
  const { data: summary } =
    trpc.complianceIntelligence.getComplianceSummary.useQuery();
  const { data: kycData } = trpc.complianceIntelligence.getKYCStatus.useQuery();
  const { data: consentsData } =
    trpc.complianceIntelligence.getConsents.useQuery();
  const { data: requestsData } =
    trpc.complianceIntelligence.getDataRequests.useQuery();
  const { data: auditData } = trpc.complianceIntelligence.getAuditLog.useQuery({
    limit: 30,
  });
  ...
  const requestExport =
    trpc.complianceIntelligence.requestDataExport.useMutation({
      onSuccess: data => {
  ...
  const requestDeletion =
    trpc.complianceIntelligence.requestDeletion.useMutation({
      onSuccess: data => {
        toast.success(data.message);
        utils.complianceIntelligence.getDataRequests.invalidate();
      },
  ...
  const cancelRequest =
    trpc.complianceIntelligence.cancelDeletionRequest.useMutation({
      onSuccess: () => {
  ...
  const kycConfig =
    KYC_STATUS_CONFIG[kycStatus] ?? KYC_STATUS_CONFIG.not_started;
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            KYC, GDPR, consent management & data rights
          </p>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <p className="text-xl font-bold text-white">
                  {summary.consentsGranted}/{summary.consentsTotal}
                </p>
              </div>
            </div>
          ...
          <Card className="bg-gray-900 border-gray-800 mb-4">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-white">
                ...
                <Badge
                  className={`ml-auto ${kycStatus === "approved" ? "bg-green-800 text-green-200" : kycStatus === "rejected" ? "bg-red-800 text-red-200" : "bg-gray-700 text-gray-300"}`}
                >
                  {kycConfig.label}
                </Badge>
              </CardTitle>
              ...
              {kycStatus === "approved" ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    Level: {kycData?.level} · Risk Score: {kycData?.riskScore}
                  </p>
                </div>
              ) : (
                <div className="space-y-4">
                  {(kycStatus === "pending" || kycStatus === "in_review") && (
                    <div className="p-3 bg-yellow-900/20 border border-yellow-700/30 rounded-lg text-yellow-300 text-sm flex items-center gap-2">
                      ...
                      Your KYC submission is being reviewed. This typically
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(v: any) =>
                          setKycForm({ ...kycForm, documentType: v })
                        }
                      >
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-900/20 border border-blue-700/30 rounded-xl flex items-start gap-3">
              ...
              <p className="text-sm text-blue-200">
                Under GDPR and CCPA, you have the right to access, export,
                correct, and delete your personal data. All requests are
              ...
              <Card className="bg-gray-900 border-gray-800">
                <CardContent className="p-4">
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    Download a complete copy of all your personal data stored on
                    this platform.
                  </p>
                  <Button
                    ...
                    >
                      <div>
                        ...
                        <p className="text-xs text-gray-500">
                          {req.scheduledAt
                            ? `Scheduled: ${formatDistanceToNow(new Date(req.scheduledAt), { addSuffix: true })}`
                            : ""}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
