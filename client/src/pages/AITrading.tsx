        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-muted-foreground">
              Advanced machine learning algorithms power automated trading
              strategies with institutional-grade risk management.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="stat-card cyber-glow text-center py-12 px-8 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-6">
              Connect your wallet and let our AI engine optimize your portfolio
