            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card className="bg-slate-800 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription>
                    Roadmap reshuffled based on signals
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="bg-slate-700 rounded p-3">
                  ...
                  <div key={i} className="bg-slate-700 rounded p-4">
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        ...
                        <Badge className="mt-1 bg-slate-600">
                          {item.impact}
                        </Badge>
                      </div>
          ...
          <TabsContent value="agents" className="space-y-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                ...
                <CardDescription>
                  Internal team consensus on feature prioritization
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-gold-900 to-slate-700 rounded p-4 border border-gold-700">
                  <p className="text-sm font-semibold text-gold-200 mb-2">
                    Merged Recommendation
                  </p>
                  <p className="text-sm text-slate-100">
                    Based on internal team debate: Proceed with implementation,
                    prioritizing UX improvements and growth strategies while
                    maintaining technical quality and risk mitigation.
                  </p>
                </div>
