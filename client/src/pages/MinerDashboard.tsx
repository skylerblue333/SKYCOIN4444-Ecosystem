      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-400">
            Real-time monitoring of all mining workers and pools
          </p>
        </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-3 h-3 rounded-full ${worker.status === "online" ? "bg-green-500" : "bg-red-500"}`}
                        />
                        <div>
                          ...
                          <p className="text-slate-400 text-sm">
                            {worker.coin} • {worker.pool}
                          </p>
                        </div>
                      </div>
                      <Badge
                        variant={
                          worker.status === "online" ? "default" : "destructive"
                        }
                      >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                      ...
                      <div>
                        ...
                        <p
                          className={`text-lg font-bold ${worker.temperature > 75 ? "text-red-400" : "text-green-400"}`}
                        >
                  ...
                  <CardContent className="pt-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">
                          {pool.coin} Mining Pool
                        </p>
                      </div>
                      <Badge
                        variant={pool.connected ? "default" : "destructive"}
                      >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-white">
                          {(
                            (pool.acceptedShares /
                              (pool.acceptedShares + pool.rejectedShares)) *
                            100
                          ).toFixed(1)}
                          %
                        </p>
        ...
        <div className="mt-8 space-y-4">
          ...
          <Alert className="bg-slate-800 border-yellow-600">
            ...
            <AlertDescription className="text-slate-300">
              RTX 4090 #1 temperature rising: 72°C (threshold: 75°C). Monitor
              closely.
            </AlertDescription>
          </Alert>
          ...
          <Alert className="bg-slate-800 border-green-600">
            ...
            <AlertDescription className="text-slate-300">
              All mining pools connected and operating normally. Daily earnings
              on track.
            </AlertDescription>
          </Alert>
        </div>
