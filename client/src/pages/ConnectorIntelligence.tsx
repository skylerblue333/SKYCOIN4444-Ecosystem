      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">
            Bi-directional platform connectors and organizational health
            monitoring
          </p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription>
              Uptime, latency, and error metrics
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
        ...
        {selectedConnectorData && (
          <>
            <Card className="bg-gradient-to-r from-blue-900/50 to-cyan-900/50 border-blue-700">
              <CardHeader>
                <CardTitle className="text-white">
                  {selectedConnectorData.name} Intelligence
                </CardTitle>
                <CardDescription>
                  {selectedConnectorData.category}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-4 gap-4">
                  {Object.entries(selectedConnectorData.metrics).map(
                    ([key, value]) => (
                      <div
                        key={key}
