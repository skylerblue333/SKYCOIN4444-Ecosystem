        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400">
              Manage reports, review teacher profiles, and maintain platform
              safety
            </p>
          </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-gray-400 text-sm">
                        ...
                        {caseItem.timestamp.toLocaleString()}
                      </p>
                    </div>
                  ...
                  {caseItem.status === "pending" && (
                    <div className="flex gap-2 pt-4 border-t border-slate-700">
                      <Button
                        ...
                        onClick={() =>
                          handleResolveCase(caseItem.id, "approve")
                        }
                      >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-400">
                        ...
                        <span>
                          Last: {teacher.lastComplaint.toLocaleString()}
                        </span>
                      </div>
                      {teacher.reason && (
                      ...
                      {teacher.status === "active" && (
                        <div className="flex gap-2">
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              handleSuspendTeacher(teacher.teacherId)
                            }
                          >
                            Suspend
                          </Button>
