...
export default function StreamClip() {
  ...
  const createClip = () => {
    if (!clipTitle) {
      toast.error("Add a title for your clip");
      return;
    }
    setCreating(true);
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-background">
      <div className="container py-8 max-w-5xl">
        <PageHeader
          ...
          icon={Scissors}
          title="Stream Clips"
          subtitle="Create, share, and discover the best moments from streams"
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {clips.map(clip => (
            <Card
              key={clip.id}
              className="border-border/50 hover:border-primary/40 transition-colors group"
            >
              <CardContent className="pt-6">
                ...
                <div className="flex gap-2 mt-4">
                  <Button
                    ...
                    variant="outline"
                    className="flex-1"
                    onClick={() => toast.success("Playing clip...")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => {
                      navigator.clipboard.writeText(
                        `https://skycoin4444.io/clips/${clip.id}`
                      );
