      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">
            Dynamic prioritization based on real-time signals and market
            conditions
          </p>
        </div>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      Priority Score: {item.priority}/100
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">
                      {Math.round(
                        ((item.signals.userDemand +
                          item.signals.marketTiming +
                          item.signals.resourceAvailability) /
                          3) *
                          100
                      )}
                      %
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-2 text-xs">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-blue-400">
                        {Math.round(item.signals.userDemand * 100)}%
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400">Market Timing:</span>
                      <span className="text-purple-400">
                        {Math.round(item.signals.marketTiming * 100)}%
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-gray-400">Resources:</span>
                      <span className="text-green-400">
                        {Math.round(item.signals.resourceAvailability * 100)}%
                      </span>
                    </div>
                  </div>
                </div>
