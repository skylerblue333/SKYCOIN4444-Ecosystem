      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            6-token ecosystem with portfolio tracking, swaps, and real-time
            prices.
          </p>
        </div>
            ...
            <div className="text-3xl font-bold font-mono mb-1">
              ...
              {isAuthenticated
                ? balances && balances.length > 0
                  ? balances
                      .reduce(
                        (sum: number, b: any) => sum + b.balance * 0.042,
                        0
                      )
                      .toFixed(2)
                  : "0.00"
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-right">
                      ...
                      <div
                        className={`text-xs font-mono flex items-center justify-end gap-0.5 ${token.change >= 0 ? "text-purple-400" : "text-red-400"}`}
                      >
                        {token.change >= 0 ? (
          ...
          <TabsContent value="defi" className="mt-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Card className="p-5 border-border/50 bg-card/80">
                ...
                <div className="text-2xl font-mono font-bold text-[oklch(0.7_0.15_280)] mb-2">
                  $2.5M TVL
                </div>
                <Button
                  size="sm"
