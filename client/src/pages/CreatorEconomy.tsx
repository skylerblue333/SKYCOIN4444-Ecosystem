...
export default function CreatorEconomy() {
  const [activeTab, setActiveTab] = useState<"tools" | "guilds" | "revenue">(
    "tools"
  );
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-gray-400">
            AI-powered tools, guilds, and revenue sharing for creators
          </p>
        </div>
            ...
            {[
              {
                ...
                desc: "Auto-generate posts, videos, captions",
              },
              {
                name: "Analytics Dashboard",
                desc: "Real-time engagement and revenue tracking",
              },
              {
                name: "Community Manager",
                desc: "AI-powered moderation and engagement",
              },
            ].map(tool => (
