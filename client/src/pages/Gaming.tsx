...
export default function Gaming() {
  ...
  const { data: tournaments, isLoading: tournamentsLoading } =
    trpc.gamefi.tournaments.useQuery();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="glow-orb w-64 h-64 top-0 right-10 animate-hero-float"
          style={{
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                <h1 className="text-4xl font-black text-rainbow">
                  SKY444 Gaming Hub
                </h1>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <div
                      className={`text-lg font-black stat-number ${stat.color}`}
                    >
                        ...
                        <div>
                          ...
                          >
                            <span className="flex items-center gap-1">
                              ...
                              {t.currentParticipants || 0}/{t.maxParticipants}{" "}
                              players
                            </span>
                            <span className="flex items-center gap-1">
                ...
                {quests.slice(0, 4).map((q: any) => (
                  ...
                  >
                    <div
                      ...
                      style={{ background: "oklch(0.72 0.28 160 / 0.15)" }}
                    >
                      <Target
                        className="w-4 h-4"
                        style={{ color: "oklch(0.72 0.28 160)" }}
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Badge
                    className="text-[10px]"
                    style={{
                      background: "oklch(0.80 0.18 70 / 0.20)",
                      color: "oklch(0.80 0.18 70)",
                      border: "none",
                    }}
                  >
                ...
                <div className="flex items-center justify-between text-xs mb-1">
                  ...
                  <span className="text-white">
                    {seasonPass.currentTier}/{seasonPass.tiers} tiers
                  </span>
                </div>
                <div
              ...
              <div className="space-y-1">
                {[
                  ...
                  <Link key={link.href} href={link.href}>
                    <div
                      className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm cursor-pointer transition-colors hover:opacity-80"
                      style={{ color: "oklch(0.60 0.025 275)" }}
                    >
                      {link.label}
                    </div>
                  </Link>
