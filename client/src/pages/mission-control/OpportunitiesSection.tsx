...
export function OpportunitiesSection() {
  ...
  const matches = trpc.hopeIntelligence.opportunities.myMatches.useQuery({
    limit: 30,
  });
  const network = trpc.hopeIntelligence.opportunities.network.useQuery({
    limit: 10,
  });
            ...
            matches.data.map(m => (
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <Badge style={{ backgroundColor: GOLD, color: "#000" }}>
                    {m.score}
                  </Badge>
                </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-white/40">
                        ...
                        {n.reputation != null ? ` · rep ${n.reputation}` : ""}
                      </div>
                    </div>
                  </div>
                </div>
