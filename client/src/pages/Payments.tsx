      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Choose a plan that fits your needs. All plans include access to the
            SKYCOIN4444 ecosystem, AI tools, and creator features.
          </p>
          <div className="flex flex-wrap gap-4 mt-6">
            {[
              ...
              { icon: Gift, label: "30-day money back" },
            ].map(({ icon: Icon, label }) => (
              <div
                key={label}
          ...
          <TabsContent value="subscriptions">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
              {SUBSCRIPTION_PLANS.map(plan => {
                ...
                return (
                  <div
                    key={plan.id}
                    className={`relative p-6 rounded-xl border ${plan.border} ${plan.bg} backdrop-blur transition-all hover:scale-[1.02]`}
                  >
                    {(plan as any).badge && (
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-baseline gap-1">
                          <span
                            className={`text-2xl font-bold font-mono ${plan.color}`}
                          >
                            ${plan.price}
                          </span>
                    ...
                    <Button
                      ...
                      variant={(plan as any).badge ? "default" : "outline"}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Use your SKYCOIN4444 tokens for any subscription and get 20%
                    off. Tokens are burned on payment.
                  </p>
                </div>
              </div>
              <Button
            ...
            <div className="mt-4 p-4 rounded-lg border border-yellow-500/20 bg-yellow-500/5">
              <p className="text-xs text-yellow-400 flex items-center gap-2">
                ...
                future expiry and CVC to test payments.
              </p>
            </div>
          </TabsContent>
  ...
  return (
    <div className="space-y-3">
      {(orders as any[]).map(order => (
        <div
          key={order.id}
          className="p-4 rounded-xl border border-border/50 bg-card/80 flex items-center justify-between"
        >
