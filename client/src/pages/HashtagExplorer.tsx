...
export default function HashtagExplorer() {
  ...
  const filtered = (trending as any[]).filter(
    (t: any) =>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-purple-950/40 via-[#050508] to-cyan-950/30 py-12">
        ...
        <div className="container max-w-5xl mx-auto px-4 relative z-10">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-black rainbow-text">
              Hashtag Explorer
            </h1>
          </div>
              ...
              <div className="space-y-2">
                {filtered.map((tag: any, i: number) => (
                  <button
                    ...
                    onClick={() =>
                      setSelectedTag(
                        selectedTag === tag.hashtag ? null : tag.hashtag
                      )
                    }
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-8 h-8 rounded-lg bg-gradient-to-br ${TAG_COLORS[i % TAG_COLORS.length]} flex items-center justify-center text-xs font-black text-white`}
                      >
                        #{i + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {tag.mentions?.toLocaleString() ?? 0} mentions
                        </div>
                      </div>
                      {i < 3 && (
            ...
            {selectedTag ? (
              ...
              <>
                ...
                {((feedData as any[]) ?? []).slice(0, 10).map((post: any) => (
                  <div
                    key={post.id}
                    className="p-4 rounded-xl border border-white/10 bg-white/3 hover:bg-white/5 transition-all"
                  >
