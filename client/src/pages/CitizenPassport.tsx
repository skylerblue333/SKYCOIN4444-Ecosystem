  ...
  return (
    <div className="p-4 rounded-xl bg-white/5 border border-white/10">
      <div className="flex justify-between items-center mb-2">
        ...
        <span
          className={`text-lg font-black font-mono ${colorMap[color] ?? "text-white"}`}
        >
          {score}
        </span>
      </div>
...
export default function CitizenPassport() {
  ...
  const getCitizenshipTier = (score: number) => {
    ...
    if (score >= 700)
      return { tier: "ELITE CITIZEN", color: "text-purple-400", badge: "💎" };
    if (score >= 500)
      return { tier: "TRUSTED CITIZEN", color: "text-blue-400", badge: "⭐" };
    if (score >= 300)
      return { tier: "ACTIVE CITIZEN", color: "text-emerald-400", badge: "✅" };
        ...
        <div className="max-w-4xl mx-auto px-6 py-10">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className={`text-lg font-bold ${tierColor} mb-3`}>
                {tier}
              </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            <ScoreBadge
              label="Learning"
              score={reputation?.learningScore ?? 0}
              max={200}
              color="blue"
            />
            <ScoreBadge
              label="Building"
              score={reputation?.builderScore ?? 0}
              max={200}
              color="yellow"
            />
            <ScoreBadge
              label="Teaching"
              score={reputation?.teachingScore ?? 0}
              max={200}
              color="emerald"
            />
            <ScoreBadge
            ...
            <div className="grid md:grid-cols-2 gap-3">
              {[
                ...
                >
                  ...
                  {item.unlocked ? (
                    <span className="ml-auto text-emerald-400 text-xs font-bold">
                      UNLOCKED
                    </span>
                  ) : (
