          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {filteredCreators.map(creator => (
                <Card
                  key={creator.id}
                  className="bg-black border-purple-500/30 p-4 hover:border-purple-500/60 transition-all cursor-pointer"
                >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex gap-3 text-xs">
                        ...
                        <span className="text-green-400 flex items-center gap-1">
                          <Sparkles className="w-3 h-3" />+{trend.growth}%
                        </span>
                      </div>
                    </div>
            ...
            <div className="mt-8">
              ...
              <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500/30 p-6">
                ...
                <p className="text-gray-400 text-sm mb-4">
                  Join exclusive groups and connect with like-minded creators
                  and investors.
                </p>
