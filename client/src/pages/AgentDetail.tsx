        ...
        <div className="rounded-2xl border border-slate-800/60 bg-slate-900/40 p-8 mb-6">
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              <div
                className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${agent.color} flex items-center justify-center`}
              >
                <Bot className="h-8 w-8 text-white" />
              </div>
              <div>
                <h1 className="text-2xl font-black text-white">{agent.name}</h1>
                <Badge className="bg-emerald-500/15 text-emerald-400 border-0 mt-1">
                  ● Active
                </Badge>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {[
              {
                label: "Tasks Run",
                value: agent.tasks.toLocaleString(),
                color: "text-cyan-400",
              },
              {
                label: "Uptime",
