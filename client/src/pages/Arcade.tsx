      ...
      <div className="container max-w-6xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">
            <span className="bg-gradient-to-r from-[oklch(0.8_0.15_90)] to-[oklch(0.7_0.2_0)] bg-clip-text text-transparent">
              Arcade
            </span>
          </h1>
          <p className="text-muted-foreground">
            Play games, earn tokens, compete in tournaments, and climb the
            leaderboards.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {gameTypes.map(g => (
            <Card
              key={g.name}
              className="p-4 border-border/50 bg-card/80 hover:border-primary/30 transition-all text-center cursor-pointer"
            >
              <g.icon
        ...
        <div className="mb-8">
          <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
            ...
            <Badge className="text-[10px] bg-yellow-500/20 text-yellow-400 border-yellow-500/30 ml-1">
              SKY444 Wagering
            </Badge>
          </h2>
            ...
            {[
              ...
              <Link key={game.name} href={game.href}>
                <Card className="p-4 border-border/50 bg-card/80 hover:border-primary/30 transition-all text-center cursor-pointer group hover:scale-105">
                  <div
                    className={`w-10 h-10 rounded-xl bg-gradient-to-br ${game.color} flex items-center justify-center mx-auto mb-2 group-hover:scale-110 transition-transform`}
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
              <Trophy className="w-5 h-5 text-[oklch(0.8_0.15_90)]" />{" "}
              Tournaments
            </h2>
            {isLoading ? (
                ...
                {tournaments.map((t: any) => (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground mb-2">
                      {t.description || "Compete for token rewards!"}
                    </p>
          ...
          <div>
            <h2 className="text-xl font-bold mb-4 flex items-center gap-2">
              <Target className="w-5 h-5 text-[oklch(0.72 0.28 305)]" /> Active
              Quests
            </h2>
                ...
                {quests.map((q: any) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge className="text-[10px] bg-[oklch(0.8_0.15_90)]/20 text-[oklch(0.8_0.15_90)]">
                        {q.xpReward} XP
                      </Badge>
                    </div>
                    <p className="text-xs text-muted-foreground mb-2">
