...
export default function EscrowShop() {
  ...
  const { data: listings, isLoading } = trpc.escrow.listListings.useQuery({
    category,
    limit: 20,
  });
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Card className="bg-gray-900 border-gray-700 p-6 mt-8">
          ...
          <p className="text-gray-400 mb-4">
            List your items on the escrow marketplace. Buyers and sellers are
            protected with secure escrow transactions.
          </p>
