  ...
  return (
    <div className="flex items-center gap-0.5">
      {[1, 2, 3, 4, 5].map(i => (
        <Star
          key={i}
          className={`${cls} ${i <= Math.round(rating) ? "text-yellow-400 fill-yellow-400" : "text-gray-600"}`}
        />
      ))}
    </div>
  );
    ...
    >
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="text-lg font-bold text-[oklch(0.72_0.28_305)]">
...
function ProductModal({
  ...
  const handleBuy = () => {
    window.open(
      `https://www.dhgate.com/product/search?q=${encodeURIComponent(product.title)}`,
      "_blank"
    );
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="relative">
            <img
              src={product.img}
              alt={product.title}
              className="w-full aspect-square object-cover rounded-tl-3xl rounded-bl-3xl"
            />
            <button
              onClick={onClose}
              className="absolute top-4 left-4 w-8 h-8 rounded-full bg-black/50 flex items-center justify-center text-white hover:bg-black/70"
            >
              ✕
            </button>
            {product.hot && (
          ...
          <div className="p-6 space-y-4">
            <div>
              <div className="text-xs text-[oklch(0.72_0.28_305)] font-semibold uppercase tracking-wider mb-1">
                {product.brand}
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 border border-white/20 rounded-xl overflow-hidden">
                <button
                  ...
                  className="px-3 py-1.5 hover:bg-white/10 text-sm"
                >
                  −
                </button>
            ...
            <div className="bg-white/5 rounded-2xl p-4 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground flex items-center gap-1">
                  <Shield className="w-3 h-3 text-[oklch(0.72_0.28_305)]" />{" "}
                  Platform Fee ({ADMIN_FEE}%)
                </span>
                <span className="text-[oklch(0.72_0.28_305)]">
                  +${(product.adminFee * qty).toFixed(2)}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground flex items-center gap-1">
              ...
              <div className="border-t border-white/10 pt-2 flex justify-between font-bold">
                <span>Total</span>
                <span className="text-[oklch(0.72_0.28_305)] text-lg">
                  ${total.toFixed(2)}
                </span>
              </div>
            ...
            <Button
              onClick={handleBuy}
              className="w-full bg-[oklch(0.72_0.28_305)] hover:bg-[oklch(0.65_0.28_305)] text-white rounded-2xl h-12 font-semibold text-base"
            >
...
export default function DHgateShop() {
  ...
  const [sortBy, setSortBy] = useState<
    "featured" | "price-low" | "price-high" | "rating" | "sold"
  >("featured");
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      case "price-low":
        return [...list].sort((a, b) => a.platformPrice - b.platformPrice);
      case "price-high":
        return [...list].sort((a, b) => b.platformPrice - a.platformPrice);
      case "rating":
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground max-w-lg">
                Premium quality bags, watches, shoes, clothing & electronics.
                All orders processed through the SKYCOIN4444 platform with buyer
                protection.
              </p>
            ...
            <div className="bg-[oklch(0.72_0.28_305)]/10 border border-[oklch(0.72_0.28_305)]/30 rounded-2xl p-4 min-w-[220px]">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-semibold text-[oklch(0.72_0.28_305)]">
                  Platform Fee
                </span>
              </div>
              <div className="text-3xl font-mono font-bold text-[oklch(0.72_0.28_305)]">
                {ADMIN_FEE}%
              </div>
              <div className="text-xs text-muted-foreground mt-1">
                Applied to all orders. Supports platform operations, buyer
                protection & creator economy.
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {hotProducts.map(p => (
            <div
              key={p.id}
              className="flex items-center gap-3 bg-[oklch(0.13_0.02_280)] border border-white/10 rounded-2xl p-3 cursor-pointer hover:border-orange-500/30 transition-all"
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="text-[oklch(0.72_0.28_305)] font-bold text-sm mt-1">
      ...
      <div className="container pb-16">
        ...
        <div className="mt-12 bg-[oklch(0.13_0.02_280)] border border-white/10 rounded-2xl p-6 text-sm text-muted-foreground">
          <div className="font-semibold text-foreground mb-2 flex items-center gap-2">
            <Shield className="w-4 h-4 text-[oklch(0.72_0.28_305)]" /> Platform
            Disclosure
          </div>
          <p>
            Products listed are sourced from DHgate.com suppliers. SKYCOIN4444
            applies a {ADMIN_FEE}% platform fee on all transactions to fund
            platform operations, buyer protection services, and the creator
            economy. All orders are subject to DHgate's buyer protection policy.
            Estimated delivery times are provided by suppliers and may vary.
            Platform fee revenue supports Skyler Blue Spillers / IITR LLC
            operations.
          </p>
        </div>
      </div>
