...
const TIMELINE = [
  ...
  {
    year: "2024 Q3",
    event: "Hope AI integrated. Watch-to-Earn and mining launched. 10K users.",
  },
  {
    year: "2025 Q1",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                SkyCoin4444 started with a simple idea: what if the time you
                spend online actually paid you back? Watch videos, play games,
                learn, create, and connect — all while earning real
                cryptocurrency.
              </p>
