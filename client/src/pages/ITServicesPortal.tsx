        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="tickets" className="space-y-4">
            ...
            {[
              ...
              <Card
                key={ticket.id}
                className="bg-slate-800 border-slate-700 p-6 hover:border-blue-500 cursor-pointer transition"
              >
                <div className="flex justify-between items-start">
          ...
          <TabsContent value="reports" className="space-y-4">
            ...
            {[
              ...
              <Card
                key={report.name}
                className="bg-slate-800 border-slate-700 p-6 flex justify-between items-center hover:border-blue-500 transition"
              >
                <div>
          ...
          <TabsContent value="invoices" className="space-y-4">
            ...
            {[
              ...
              <Card
                key={invoice.id}
                className="bg-slate-800 border-slate-700 p-6 flex justify-between items-center"
              >
                <div>
