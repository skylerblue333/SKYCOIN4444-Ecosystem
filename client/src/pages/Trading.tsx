  ...
  return (
    <div className="container py-8 max-w-6xl animate-page-in">
      <PageHeader
        ...
        subtitle="Real-time crypto trading with AI-powered signals and 5 bot strategies"
        actions={
          <Link href="/day-trade">
          ...
          <div className="divide-y divide-border/50">
            {PAIRS.map(p => (
              ...
              >
                ...
                <div
                  className={`flex items-center gap-1 text-sm font-medium ${p.change > 0 ? "text-success" : "text-destructive"}`}
                >
                  {p.change > 0 ? (
