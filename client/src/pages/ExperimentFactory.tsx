...
export default function ExperimentFactory() {
  ...
  const selectedExperimentData = experiments.find(
        ...
        {selectedExperimentData && (
          <>
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    ...
                    <p className="text-lg font-bold text-white">
                      {Math.round(selectedExperimentData.confidence * 100)}%
                    </p>
                  </div>
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    ...
                    <p className="text-lg font-bold text-white">
                      {(
                        selectedExperimentData.controlGroup +
                        selectedExperimentData.treatmentGroup
                      ).toLocaleString()}
                    </p>
                  </div>
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    ...
                    <p className="text-lg font-bold text-green-400">
                      {selectedExperimentData.recommendation}
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-slate-800/50 border-slate-700">
              ...
              <CardContent className="space-y-4">
                {Object.entries(selectedExperimentData.metrics).map(
                  ([metricName, values]: any) => (
                    <div
                      key={metricName}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <p className="text-lg font-bold text-white">
                            {typeof values.control === "number" &&
                            values.control < 1
                              ? (values.control * 100).toFixed(1) + "%"
                              : values.control}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-lg font-bold text-green-400">
                            {typeof values.treatment === "number" &&
                            values.treatment < 1
                              ? (values.treatment * 100).toFixed(1) + "%"
                              : values.treatment}
                          </p>
                        </div>
                      </div>
