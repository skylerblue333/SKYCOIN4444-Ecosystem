    ...
    const interval = setInterval(() => {
      setPrices(prev => ({
        BTC: {
          ...
          change: prev.BTC.change + (Math.random() - 0.5) * 2,
        },
        ETH: {
          price: prev.ETH.price + (Math.random() - 0.5) * 50,
          change: prev.ETH.change + (Math.random() - 0.5) * 2,
        },
        SKY4444: {
          price: prev.SKY4444.price + (Math.random() - 0.5) * 0.5,
          change: prev.SKY4444.change + (Math.random() - 0.5) * 5,
        },
        DOGE: {
          price: prev.DOGE.price + (Math.random() - 0.5) * 0.05,
          change: prev.DOGE.change + (Math.random() - 0.5) * 3,
        },
        TRUMP: {
          price: prev.TRUMP.price + (Math.random() - 0.5) * 1,
          change: prev.TRUMP.change + (Math.random() - 0.5) * 4,
        },
      }));
    }, 5000);
      ...
      <section className="relative py-24 md:py-32 overflow-hidden">
        ...
        <div className="container relative z-10 text-center">
            ...
            <div className="flex gap-8 justify-center items-center text-sm font-mono whitespace-nowrap animate-pulse">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/80">
                  ${prices.BTC.price.toFixed(0)}
                </span>
                <span
                  className={
                    prices.BTC.change > 0 ? "text-green-400" : "text-red-400"
                  }
                >
                  {prices.BTC.change > 0 ? "+" : ""}
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/80">
                  ${prices.ETH.price.toFixed(0)}
                </span>
                <span
                  className={
                    prices.ETH.change > 0 ? "text-green-400" : "text-red-400"
                  }
                >
                  {prices.ETH.change > 0 ? "+" : ""}
                  {prices.ETH.change.toFixed(2)}%
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-amber-500 font-bold">SKY4444</span>
                <span className="text-white/80">
                  ${prices.SKY4444.price.toFixed(2)}
                </span>
                <span
                  className={
                    prices.SKY4444.change > 0
                      ? "text-green-400"
                      : "text-red-400"
                  }
                >
                  {prices.SKY4444.change > 0 ? "+" : ""}
                  {prices.SKY4444.change.toFixed(2)}%
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-yellow-400 font-bold">DOGE</span>
                <span className="text-white/80">
                  ${prices.DOGE.price.toFixed(2)}
                </span>
                <span
                  className={
                ...
                >
                  {prices.DOGE.change > 0 ? "+" : ""}
                  {prices.DOGE.change.toFixed(2)}%
                </span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-red-400 font-bold">TRUMP</span>
                <span className="text-white/80">
                  ${prices.TRUMP.price.toFixed(2)}
                </span>
                <span
                  className={
                    prices.TRUMP.change > 0 ? "text-green-400" : "text-red-400"
                  }
                >
                  {prices.TRUMP.change > 0 ? "+" : ""}
                  {prices.TRUMP.change.toFixed(2)}%
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 flex justify-center">
            <a
              href="/governance"
              className="group inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-green-500/40 bg-green-500/10 hover:bg-green-500/20 transition-all duration-200 cursor-pointer"
            >
          ...
          <div className="max-w-3xl mx-auto mb-4">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              Ask Hope AI to stake tokens, buy products, tip creators, launch
              campaigns, or execute trades &mdash; all from a single message.
              SKYCOIN4444 is a{" "}
              <span className="text-foreground font-semibold">
                fully integrated AI-powered digital ecosystem
              </span>{" "}
              combining Social, Finance, Gaming, Commerce, Governance, and
              Privacy into one operating system. Powered by{" "}
            ...
            <form onSubmit={handleHeroSubmit} className="group">
              ...
              >
                ...
                <div className="flex items-center gap-2 px-4 pt-3 pb-2 border-b border-white/5">
                  ...
                  <span className="text-xs font-mono text-[oklch(0.72_0.28_305)] uppercase tracking-widest font-semibold">
                ...
                <div className="flex gap-3 px-4 py-3">
                  <span className="text-[oklch(0.72_0.28_305)] font-mono text-xl select-none mt-1">
                    &gt;
                  </span>
                  <textarea
                    ref={heroInputRef}
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            ...
            <div className="flex flex-col items-center gap-1">
              <a href={getLoginUrl()}>
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-amber-500 to-yellow-400 hover:from-amber-400 hover:to-yellow-300 text-black font-bold gap-2 h-14 px-8 shadow-xl text-base rounded-2xl"
                  style={{ boxShadow: "0 0 30px oklch(0.8 0.2 80 / 0.4)" }}
                >
            ...
            <Link href="/hope-ai">
              <Button
                size="lg"
                className="gradient-psychedelic text-white font-bold gap-2 h-12 px-7 shadow-lg"
            ...
            <Link href="/home">
              <Button
                size="lg"
                className="bg-[oklch(0.72_0.28_305)] hover:bg-[oklch(0.65_0.28_305)] text-black font-semibold gap-2 h-12 px-6"
              >
            ...
            <Link href="/staking">
              <Button
                size="lg"
                variant="outline"
                className="border-[oklch(0.72_0.28_305)]/50 text-[oklch(0.72_0.28_305)] hover:bg-[oklch(0.72_0.28_305)]/10 gap-2 h-12 px-6"
              >
            ...
            <Link href="/investor">
              <Button
                size="lg"
                variant="outline"
                className="border-[oklch(0.72_0.28_340)]/50 text-[oklch(0.72_0.28_340)] hover:bg-[oklch(0.72_0.28_340)]/10 gap-2 h-12 px-6"
              >
            ...
            <Link href="/proof-vault">
              <Button
                size="lg"
                variant="ghost"
                className="text-muted-foreground hover:text-foreground gap-2 h-12 px-6"
              >
            ...
            <div className="stat-card">
              ...
              <div className="text-xl md:text-2xl font-mono font-bold">
                {isLoading ? (
                  ...
                  communitiesCount.toLocaleString()
                )}
              </div>
              <div className="text-xs text-muted-foreground uppercase tracking-wider mt-1">
                Communities
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col items-center md:items-start gap-6">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-[oklch(0.72_0.28_305)] font-mono text-sm mb-1">
                    Founder &amp; Architect — SKYCOIN4444
                  </p>
                  <p className="text-muted-foreground text-xs mb-3 font-medium">
                    Developer · Innovative Information Technology Resolutions
                    LLC
                  </p>
                  {/* Faith & Family */}
                  ...
                  <div className="flex flex-wrap gap-1.5 justify-center md:justify-start">
                    {[
                      ...
                      <span
                        key={tag}
                        className="px-2 py-0.5 rounded-full text-xs border border-[oklch(0.72_0.28_305)]/30 bg-[oklch(0.72_0.28_305)]/10 text-[oklch(0.72_0.28_305)] font-mono"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              <div className="space-y-5">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[oklch(0.72_0.28_305)]/30 bg-[oklch(0.72_0.28_305)]/5">
                  ...
                  <span className="text-xs font-mono text-[oklch(0.72_0.28_305)]">
                ...
                <h3 className="text-2xl md:text-3xl font-bold leading-tight">
                  Built by one person.
                  <br />
                  <span className="text-[oklch(0.72_0.28_305)]">
                ...
                <blockquote className="border-l-4 border-[oklch(0.72_0.28_305)] pl-4 py-1">
                  <p className="text-[oklch(0.72_0.28_305)] font-semibold italic leading-snug">
                    "I'm not a slave to robots — I have robots as slaves. I
                ...
                <p className="text-muted-foreground leading-relaxed">
                  I'm <strong>Skyler Blue Spillers</strong> — software engineer,
                  IT consultant, AI architect, and ecosystem builder. Developer
                  of{" "}
                  <span className="text-[oklch(0.72_0.28_305)] font-semibold">
                    Innovative Information Technology Resolutions LLC (IITR LLC)
                  </span>
                  . What started as a vision became a full production-grade
                  AI-powered Web3 ecosystem — built by one person.
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    {
                      emoji: "🤖",
                      label: "44 AI Agents Working Autonomously",
                      bg: "bg-cyan-500/10 border-cyan-500/30",
                      text: "text-cyan-300",
                    },
                    {
                      emoji: "🔐",
                      label: "Digital Sovereignty Architect",
                    ...
                    <div
                      key={b.label}
                      className={`flex items-center gap-1.5 ${b.bg} border rounded-full px-3 py-1.5`}
                    >
                ...
                <div className="rounded-2xl border border-[oklch(0.72_0.28_305)]/30 bg-[oklch(0.72_0.28_305)]/5 p-4 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono text-[oklch(0.72_0.28_305)] uppercase tracking-wider">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      {
                        label: "Platform Codebase (299K+ LOC)",
                        value: "$2.1M",
                        note: "3× dev cost at $140/hr",
                      },
                      {
                        label: "AI Engine Suite (44 agents)",
                        value: "$780K",
                        note: "Proprietary ML pipeline",
                      },
                      {
                        label: "Crypto Infrastructure (SKY444)",
                        value: "$290K",
                      ...
                      <div
                        key={item.label}
                        className="flex flex-col gap-0.5 bg-white/5 rounded-lg px-3 py-2"
                      >
                        <div className="flex justify-between items-center gap-2">
                          <span className="text-muted-foreground text-xs leading-tight">
                            {item.label}
                          </span>
                          <span className="text-[oklch(0.72_0.28_305)] font-mono font-bold text-xs whitespace-nowrap">
                            {item.value}
                          </span>
                        </div>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/10">
                    ...
                    <span className="text-xl font-mono font-bold text-[oklch(0.72_0.28_305)]">
                      ~$4.0M
                    </span>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-yellow-500/30 bg-yellow-500/5 p-4 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono text-yellow-400 uppercase tracking-wider">
                      SKYCOIN4444 — Theoretical Net Worth After Token
                      Appreciation
                    </span>
                  </div>
                  <p className="text-xs text-muted-foreground">
                    ICO opens April 24, 2027. These are speculative projections
                    based on comparable platform token launches — not financial
                    advice.
                  </p>
                  <div className="grid grid-cols-2 gap-2">
                    {[
                  ...
                  <p className="text-[10px] text-white/30">
                    Assumes founder retains 10% of total supply. Technical net
                    worth ($4.0M) is the honest baseline — token appreciation is
                    speculative upside only.
                  </p>
                </div>

                <p className="text-muted-foreground leading-relaxed">
                  Most platforms spend $2M–$5M and 2 years to build what I
                  engineered here. Every line of code, every database schema,
                  every AI integration, every crypto flow — designed and shipped
                  by one architect. My AI systems mine cryptocurrency, generate
                  content, rank feeds, moderate communities, and execute trades
                  —{" "}
                  <span className="text-foreground font-semibold">
                    all while I sleep.
                  </span>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  , I deliver enterprise-grade IT consulting, custom software
                  development, cybersecurity solutions, and AI-powered systems.
                  God first. Family always. Three daughters who remind me every
                  day why the mission matters.
                </p>
                {/* Key achievements */}
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="stat-card flex items-center gap-3 p-3"
                    >
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-rainbow-slow section-header-neon">
              How{" "}
              <span className="text-[oklch(0.72_0.28_305)]">SKYCOIN4444</span>{" "}
              Works
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Four interconnected layers that form a complete digital operating
              system.
            </p>
          </div>
              ...
              <Link key={step.step} href={step.href}>
                <div className="stat-card group hover:border-[oklch(0.72_0.28_305)]/50 transition-all duration-300 cursor-pointer h-full flex flex-col">
                  <div className="flex items-center justify-between mb-4">
                    <span
                      className="text-4xl font-mono font-bold opacity-10 group-hover:opacity-20 transition-opacity"
                      style={{ color: `var(--accent, ${step.color})` }}
                    >
                      {step.step}
                    </span>
                    <div
                  ...
                  <h3 className="text-xl font-bold mb-0.5 group-hover:text-[oklch(0.72_0.28_305)] transition-colors">
                    {step.title}
                  </h3>
              ...
              <Link key={feat.title} href={feat.href}>
                <div className="stat-card group hover:border-[oklch(0.72_0.28_305)]/50 transition-all duration-300 cursor-pointer">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-sm mb-1 group-hover:text-[oklch(0.72_0.28_305)] transition-colors">
                        {feat.title}
                      </h4>
        ...
        <div className="container relative z-10">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[oklch(0.72_0.28_305)]/30 bg-[oklch(0.72_0.28_305)]/5 mb-4">
              ...
              <span className="text-xs font-mono text-[oklch(0.72_0.28_305)]">
                LIVE NOW — 6 CORE EXPERIENCES
              </span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-rainbow-slow section-header-neon">
              Everything{" "}
              <span className="text-[oklch(0.72_0.28_305)]">Live</span> in One
              Platform
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Real DB-backed, AI-powered, SKY444-rewarded. Every section is
            ...
            {[
              {
                ...
                stats: [
                  { v: stats?.totalPosts?.toLocaleString() ?? "0", l: "Posts" },
                  {
                    v: stats?.onlineUsers?.toLocaleString() ?? "0",
                    l: "Online",
                  },
                ],
              },
              {
                ...
                stats: [
                  {
                    v: stats?.totalStreams?.toLocaleString() ?? "0",
                    l: "Streams",
                  },
                  { v: "HLS", l: "Protocol" },
                ],
              ...
              <Link key={card.label} href={card.href}>
                ...
                >
                  ...
                  <h3 className="text-lg font-bold mb-2 group-hover:text-[oklch(0.72_0.28_305)] transition-colors">
                    {card.label}
                  </h3>
      ...
      <section className="py-20 border-t border-border/50 relative overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Every metric is real. Every line is compiled. Every endpoint is
              live. Production build complete.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
            {[
              ...
              { icon: CheckCircle, value: "65/65", label: "Tests" },
              ...
              <div
                key={stat.label}
                className="stat-card text-center group hover:border-[oklch(0.72_0.28_305)]/50 transition-all"
              >
              ...
              <div className="stat-card relative overflow-hidden p-8">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    <span className="text-[oklch(0.72_0.28_305)] font-bold">
                      all of them
                    </span>{" "}
                  ...
                  <p className="text-sm text-muted-foreground mb-6">
                    Most startups spend $2M–$5M+ and 12–24 months trying to
                    build this level of infrastructure. This was engineered into
                    existence now.
                  </p>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-[oklch(0.72_0.28_305)]/5 border border-[oklch(0.72_0.28_305)]/20">
                    ...
                    <div>
                      ...
                      <div className="text-xl font-mono font-bold text-[oklch(0.8_0.15_90)]">
                        9.9 / 10
                      </div>
                    </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="space-y-3 mb-6">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono font-bold text-[oklch(0.72_0.28_305)]">
                        $5M–$20M+
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono font-bold text-muted-foreground line-through">
                        $50+/feature
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono font-bold text-[oklch(0.8_0.15_90)]">
                        28x
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-mono font-bold text-[oklch(0.72_0.28_340)]">
                        1000x+
                      </span>
                    </div>
                  </div>
                  <div className="p-3 rounded-lg bg-[oklch(0.72_0.28_340)]/5 border border-[oklch(0.72_0.28_340)]/20">
                    <div className="text-xs text-muted-foreground">
                      Before: user growth, tokenization, licensing, enterprise
                      integrations, marketplace revenue, AI subscriptions
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[oklch(0.72_0.28_340)]/30 bg-[oklch(0.72_0.28_340)]/5 mb-4">
              ...
              <span className="text-xs font-mono text-[oklch(0.72_0.28_340)]">
            ...
            <Link href="/explore">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 hover:text-primary transition-colors cursor-pointer">
                Comprehensive{" "}
                <span className="text-[oklch(0.72_0.28_305)]">Ecosystem</span>{" "}
                <ArrowRight className="inline w-6 h-6 text-muted-foreground" />
              </h2>
            </Link>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Everything you need to learn, build, create, trade, and
              collaborate — all under one roof.
            </p>
          </div>
              ...
              <Link key={mod.name} href={mod.href} className="block">
                <div className="group flex items-center gap-3 px-4 py-3 rounded-xl border border-border/40 bg-card/50 hover:border-[oklch(0.72_0.28_305)]/50 hover:bg-[oklch(0.72_0.28_305)]/5 transition-all duration-200 cursor-pointer h-full active:scale-[0.99]">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-sm group-hover:text-[oklch(0.72_0.28_305)] transition-colors truncate">
                      {mod.name}
                    </div>
        ...
        <div className="container">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[oklch(0.8_0.15_90)]/30 bg-[oklch(0.8_0.15_90)]/5 mb-4">
              ...
              <span className="text-xs font-mono text-[oklch(0.8_0.15_90)]">
                6-TOKEN ECOSYSTEM
              </span>
            </div>
            <Link href="/token-metrics">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 hover:text-primary transition-colors cursor-pointer">
                Integrated{" "}
                <span className="text-[oklch(0.8_0.15_90)]">Token System</span>{" "}
                <ArrowRight className="inline w-6 h-6 text-muted-foreground" />
              </h2>
            </Link>
            <p className="text-muted-foreground">
              Multi-token architecture designed for different use cases across
              the platform.
            </p>
          </div>
          ...
          <div className="flex justify-center mb-4">
            <Link href="/governance">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-green-500/10 border border-green-500/20 text-green-300 text-xs font-medium hover:bg-green-500/20 transition-colors cursor-pointer">
                ✅ Genesis Vote #001 PASSED — DOGE + TRUMP approved as ecosystem
                tokens
              </span>
            </Link>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-3 max-w-5xl mx-auto">
            {TOKENS.map(token => (
              <Link key={token.symbol} href="/global-ops">
                <div
                  className={`stat-card text-center group hover:border-amber-500/30 transition-all cursor-pointer ${token.bg} border ${token.border}`}
                >
                  <div className="text-2xl mb-1">{token.emoji}</div>
                  <div
                    className={`text-sm font-mono font-bold mb-0.5 ${token.color}`}
                  >
                    {token.symbol}
                  </div>
                  ...
                  {token.genesis && (
                    <span className="mt-1 inline-block text-xs text-green-400 font-medium">
                      ✓ Genesis
                    </span>
                  )}
                </div>
          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-6">
            ...
            <div className="stat-card p-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Natural language voice control across every module. Navigate,
                trade, search, and create — hands-free.
              </p>
              <div className="grid grid-cols-2 gap-1.5">
                {[
                  ...
                  <div
                    key={cmd}
                    className="flex items-center gap-1.5 text-xs px-2 py-1.5 rounded-lg bg-white/[0.02] border border-white/5"
                  >
                    <span className="text-[oklch(0.72_0.28_305)] font-mono shrink-0">
                      &gt;
                    </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  >
                    ...
                    <span className="text-[10px] font-mono font-bold text-emerald-400 ml-auto shrink-0">
                      {item.status}
                    </span>
                  </div>
                ))}
      ...
      <section className="py-20 border-t border-border/50">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-rainbow-slow section-header-neon">
              Live{" "}
              <span className="text-[oklch(0.72_0.28_305)]">Resources</span>
            </h2>
            <p className="text-muted-foreground">
              All repositories, demos, and downloads — publicly accessible and
              verifiable.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto mb-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="stat-card group hover:border-[oklch(0.72_0.28_305)]/50 transition-all flex items-center gap-4"
            >
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground font-mono">
              Checkpoint: da3303fb &middot; Production Build Complete &middot; 6
              GitHub Repositories
            </p>
          </div>
        </div>
      ...
      <section className="py-24 border-t border-border/50 relative overflow-hidden">
        ...
        <div className="container text-center relative z-10">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-rainbow-slow section-header-neon">
            ...
            <span className="text-[oklch(0.72_0.28_305)]">Production</span>.
          </h2>
          <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-4">
            The code is real. The infrastructure is live. The rarity is in the
            execution.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/ecosystem">
              <Button
                size="lg"
                className="bg-[oklch(0.72_0.28_305)] hover:bg-[oklch(0.65_0.28_305)] text-black font-semibold gap-2 h-12 px-8"
              >
            ...
            <Link href="/staking">
              <Button
                size="lg"
                variant="outline"
                className="border-[oklch(0.72_0.28_305)]/50 text-[oklch(0.72_0.28_305)] hover:bg-[oklch(0.72_0.28_305)]/10 gap-2 h-12 px-8"
              >
                <Coins className="w-5 h-5" />
                Start Staking
              </Button>
            ...
            <Link href="/token">
              <Button
                size="lg"
                variant="ghost"
                className="text-muted-foreground hover:text-foreground gap-2 h-12 px-8"
              >
                <TrendingUp className="w-5 h-5" />
                SKY444 Token
              </Button>
