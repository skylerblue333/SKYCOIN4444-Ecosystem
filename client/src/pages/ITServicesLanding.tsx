...
export default function ITServicesLanding() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Robust software development, cybersecurity, and AI solutions for
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center mb-12">
            ...
            <p className="text-slate-300">
              Led by Skyler Blue, a seasoned technology expert with advanced
              credentials
            </p>
          </div>
          ...
          <div className="mt-8 text-center text-slate-400">
            <p>
              Father of 3 daughters | Committed to secure, innovative technology
              solutions
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                Custom applications, cloud-native architecture, microservices,
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                24/7 monitoring, infrastructure management, patch management,
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                Security audits, penetration testing, SOC services, and
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                Predictive analytics, threat detection, data science, and
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                Smart contracts, DeFi development, security audits, and Web3
                strategy.
              </p>
            ...
            <Card className="bg-slate-800 border-slate-700 p-8 hover:border-blue-500 transition">
              ...
              <p className="text-slate-300 mb-4">
                Technology roadmap, architecture design, vendor management, and
                cost optimization.
              </p>
      ...
      <section
        id="pricing"
        className="bg-slate-900/50 py-20 border-y border-slate-800"
      >
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-white text-center mb-16">
            Service Packages
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="bg-slate-800 border-slate-700 p-8">
              ...
              <p className="text-4xl font-bold text-blue-400 mb-6">
                $500<span className="text-lg text-slate-400">/month</span>
              </p>
            ...
            <Card className="bg-blue-900/30 border-blue-500 p-8 relative">
              ...
              <p className="text-4xl font-bold text-blue-400 mb-6">
                $2,500<span className="text-lg text-slate-400">/month</span>
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex gap-2 text-slate-300">
                  <CheckCircle className="h-5 w-5 text-blue-400 flex-shrink-0" />
            ...
            <Card className="bg-slate-800 border-slate-700 p-8">
              ...
              <p className="text-4xl font-bold text-blue-400 mb-6">
                $10,000<span className="text-lg text-slate-400">/month</span>
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex gap-2 text-slate-300">
                  <CheckCircle className="h-5 w-5 text-blue-400 flex-shrink-0" />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
            Schedule a free consultation with our founder to discuss your
      ...
      <footer className="border-t border-slate-800 bg-slate-950 py-12">
        <div className="container mx-auto px-4 text-center text-slate-400">
          <p>
            &copy; 2026 Innovative Information Technology Resolutions. All
            rights reserved.
          </p>
          <p className="mt-2">
            Founder: Skyler Blue | CEH | M.S. Cybersecurity | Father of 3
          </p>
        </div>
      </footer>
    </div>
