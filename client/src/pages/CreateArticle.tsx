              ...
              <div className="flex flex-wrap items-center gap-1 p-2 rounded-xl border border-border/50 bg-card/30 mb-4">
                {[
                  ...
                  <button
                    key={label}
                    title={label}
                    className="p-1.5 rounded-lg hover:bg-card/80 text-muted-foreground hover:text-foreground transition-colors"
                  >
            ...
            <div className="space-y-2">
              {(
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-xl border transition-all text-left ${visibility === v.value ? "border-primary/50 bg-primary/10" : "border-border/50 hover:border-border"}`}
                >
          ...
          <div className="rounded-xl border border-yellow-500/30 bg-yellow-500/5 p-4">
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              <div className="flex justify-between">
                <span>Tip button</span>
                <span className="text-purple-400">Enabled</span>
              </div>
              <div className="flex justify-between">
                <span>Subscriber bonus</span>
                <span className="text-purple-400">+20%</span>
              </div>
              <div className="flex justify-between">
                <span>Est. per 1K reads</span>
                <span className="text-yellow-400">~44 SKY444</span>
              </div>
            </div>
          </div>
        </div>
