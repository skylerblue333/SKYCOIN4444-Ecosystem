        ...
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-cyan-900/20 border border-white/10 p-8">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-white/60 max-w-xl mx-auto mb-6">
              The SKYCOIN4444 Embed SDK lets you add wallet, AI, social, and
              payment features to any website with 3 lines of code.
            </p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {WIDGETS.map(w => (
              <div
                key={w.label}
                className="feature-card p-5 hover:border-blue-500/30 transition-all group"
              >
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={p.name}
                className={`rounded-2xl border p-6 ${p.highlight ? "border-purple-500/50 bg-purple-900/20" : "border-white/10 bg-white/2"}`}
              >
                {p.highlight && (
                ...
                <Button
                  ...
                  onClick={() =>
                    toast.info(`${p.name} plan — contact sales@skycoin4444.com`)
                  }
                >
