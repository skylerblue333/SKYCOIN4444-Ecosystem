...
export default function PayoutDashboard() {
  ...
  const handleRequestPayout = () => {
    ...
    toast.success(
      `Payout of $${amt.toFixed(2)} requested via ${method === "bank" ? "Bank Transfer" : "Crypto"}`
    );
    setRequestAmount("");
  };
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            },
            {
              ...
              value: `$${lifetimePayouts.toLocaleString()}`,
              icon: CheckCircle,
              color: "text-blue-400",
              sub: "All time",
            },
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-[10px] text-slate-600 mt-1">
                  Available: ${availableBalance.toLocaleString()} · Min: $50
                </p>
              </div>
              <div>
                <label className="text-xs text-slate-400 mb-1 block">
        ...
        <div className="bg-slate-900/60 border border-slate-800 rounded-xl overflow-hidden">
          <div className="p-4 border-b border-slate-800 flex items-center justify-between">
            ...
            <Badge className="bg-slate-800 text-slate-400 border-slate-700 text-xs">
              {PAYOUT_HISTORY.length} transactions
            </Badge>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <Badge
                      className={`text-[9px] px-1.5 py-0.5 ${color} bg-transparent border-current`}
                    >
                      {label}
                    </Badge>
                  </div>
        ...
        <div className="mt-6 flex items-start gap-3 p-4 bg-yellow-900/10 border border-yellow-500/20 rounded-xl">
          ...
          <p className="text-xs text-slate-400">
            Earnings may be subject to tax reporting requirements. Creators
            earning over $600/year will receive a 1099-K form. Consult a tax
