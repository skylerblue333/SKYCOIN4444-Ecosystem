              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${model.status === "active" ? "bg-green-500/20 text-green-400" : model.status === "training" ? "bg-yellow-500/20 text-yellow-400" : "bg-secondary text-muted-foreground"}`}
                    >
                      {model.status}
                    </span>
                  </div>
