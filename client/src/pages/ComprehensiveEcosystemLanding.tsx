  ...
  const features = [
    {
      ...
      description:
        "AI-powered mining for BTC, ETH, SOL, DOGE, and SKY444 with 128 concurrent workers",
    },
    {
      icon: <TrendingUp className="h-8 w-8 text-green-500" />,
      title: "Advanced Trading",
      description:
        "Intelligent trading bots with real-time market data and AI-driven strategies",
    },
    {
      icon: <Users className="h-8 w-8 text-purple-500" />,
      title: "Social Ecosystem",
      description:
        "Integrated social platform with gaming, streaming, and community features",
    },
    {
      icon: <Shield className="h-8 w-8 text-orange-500" />,
      title: "Secure Wallets",
      description:
        "Multi-signature wallet support with hardware integration and full custody control",
    },
    {
      icon: <Cpu className="h-8 w-8 text-red-500" />,
      title: "Scalable Backend",
      description:
        "14 routers, 80+ API procedures, optimized for scale and performance",
    },
    {
      icon: <Globe className="h-8 w-8 text-cyan-500" />,
      title: "Global Marketplace",
      description:
        "Decentralized marketplace with commission-based revenue model",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="relative overflow-hidden px-4 py-20 md:py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            A comprehensive, production-ready platform valued at{" "}
            <span className="text-green-400 font-bold">
              ${ecosystemStats.technicalNetWorth}
            </span>{" "}
            with 1,076 pages, enterprise backend, and AI-powered crypto mining.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Link href="/whitepaper">
              <Button
                variant="outline"
                className="border-blue-500 text-blue-300 hover:bg-blue-500/20 text-lg px-8 py-6 rounded-lg shadow-lg transition-all duration-300"
              >
                Read Whitepaper
              </Button>
            </Link>
      ...
      <section className="py-20 px-4 bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-12 max-w-2xl mx-auto">
            A complete ecosystem combining mining, trading, social, gaming, and
            enterprise tools
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, idx) => (
              <Card
                key={idx}
                className="bg-slate-700/50 border-slate-600 hover:border-blue-500 transition-all duration-300 transform hover:scale-105"
              >
                <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-orange-400">
                        {ecosystemStats.apiProcedures}+
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Database Tables:</span>
                      <span className="font-bold text-pink-400">
                        {ecosystemStats.databaseTables}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-slate-700/50 border-slate-600">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-green-400">
                        {ecosystemStats.developmentCost}
                      </span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-bold text-purple-400">
                        {ecosystemStats.rarityScore}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-400">Current Net Worth:</span>
                      <span className="font-bold text-pink-400">
                        {ecosystemStats.currentNetWorth}
                      </span>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="mining" className="mt-8">
              <Card className="bg-slate-700/50 border-slate-600">
                <CardHeader>
                  ...
                  <CardDescription>
                    Real-time earnings from multi-crypto mining
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center p-6 bg-slate-800/50 rounded-lg">
                      <div className="text-4xl font-bold text-green-400 mb-2">
                        {ecosystemStats.dailyMiningEarnings}
                      </div>
                      <div className="text-gray-400">Daily Earnings</div>
                    </div>
                    <div className="text-center p-6 bg-slate-800/50 rounded-lg">
                      <div className="text-4xl font-bold text-blue-400 mb-2">
                        {ecosystemStats.monthlyProjection}
                      </div>
                      <div className="text-gray-400">Monthly Projection</div>
                    </div>
                    <div className="text-center p-6 bg-slate-800/50 rounded-lg">
                      <div className="text-4xl font-bold text-purple-400 mb-2">
                        {ecosystemStats.yearlyProjection}
                      </div>
                      <div className="text-gray-400">Yearly Projection</div>
                    </div>
                  </div>
                  <p className="mt-6 text-gray-300 text-center">
                    128 concurrent mining workers optimized for maximum
                    efficiency across BTC, ETH, SOL, DOGE, and SKY444
                  </p>
                </CardContent>
              </Card>
            </TabsContent>
                ...
                {categories.map((cat, idx) => (
                  <Card key={idx} className="bg-slate-700/50 border-slate-600">
                    <CardContent className="pt-6 text-center">
                      <div
                        className={`${cat.color} text-white font-bold text-2xl mb-2 py-2 rounded`}
                      >
                        {cat.pages}
                      </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Experience the future of Web3 with SKY444 Ecosystem. Start mining,
            trading, and earning today.
          </p>
          <Link href="/signup">
      ...
      <footer className="bg-slate-900 py-12 px-4 border-t border-slate-800">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              The comprehensive Web3 ecosystem for mining, trading, and earning.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link href="/gaming" className="hover:text-blue-400">
                  Gaming
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/whitepaper" className="hover:text-blue-400">
                  Whitepaper
                </Link>
              </li>
              <li>
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-8 border-t border-slate-800 text-center text-gray-400">
          <p>
            &copy; 2026 SKY444 Ecosystem. All rights reserved. | Valued at
            $2,000,000+ | 1,076 Pages | Scalable-Grade Platform
          </p>
        </div>
      </footer>
    </div>
