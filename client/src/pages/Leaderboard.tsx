...
function LeaderRow({
  ...
  return (
    <div
      ...
      style={{
        background: isTop3
          ? "oklch(0.72 0.28 305 / 0.08)"
          : "oklch(0.10 0.025 270)",
    ...
    >
      ...
      <div className="text-right flex-shrink-0">
        <p
          ...
          style={{ color: isTop3 ? "oklch(0.85 0.25 305)" : "white" }}
        >
...
export default function Leaderboard() {
  ...
  const { data: users, isLoading } = trpc.user.leaderboard.useQuery({
    type: tab as any,
    limit: 50,
  });
            ...
            {(() => {
              ...
              return (
                <LeaderRow
                  rank={myRank + 1}
                  user={myUser}
                  value={(myUser as any)[tabConf.valueKey] || 0}
                  label={tabConf.valueLabel}
                />
              );
            })()}
          </div>
