      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription>
              Weekly usage of playbooks over time
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="flex items-start justify-between mb-2">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-400 mt-1">
                      v{playbook.version} • Updated {playbook.lastUpdated}
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge variant="outline">{playbook.usage} uses</Badge>
                    <Badge className="bg-green-900 text-green-300">
                      {Math.round(playbook.effectiveness * 100)}%
                    </Badge>
                  </div>
                </div>
              </button>
          ...
          <>
            <Card className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 border-indigo-700">
              <CardHeader>
                ...
                <CardDescription>
                  v{selectedPlaybookData.version} • Last updated{" "}
                  {selectedPlaybookData.lastUpdated}
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    ...
                    <p className="text-2xl font-bold text-white">
                      {selectedPlaybookData.usage}
                    </p>
                  </div>
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    <p className="text-xs text-gray-400">Effectiveness</p>
                    <p className="text-2xl font-bold text-white">
                      {Math.round(selectedPlaybookData.effectiveness * 100)}%
                    </p>
                  </div>
                  <div className="p-3 bg-slate-700/50 rounded border border-slate-600">
                    <p className="text-xs text-gray-400">Sections</p>
                    <p className="text-2xl font-bold text-white">
                      {selectedPlaybookData.sections.length}
                    </p>
                  </div>
                </div>
