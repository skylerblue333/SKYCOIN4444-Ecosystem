...
const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    paidResult:
      "5 custom bios (Share2, LinkedIn, website, press, dating) + headline variations",
    basicPrice: 1.99,
    premiumPrice: 6.99,
    powerPrice: 14.99,
    category: "Writing",
      ...
      <div className="max-w-2xl mx-auto p-4 space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                ...
                <span className="text-green-400 font-medium">paid unlock</span>{" "}
                for the full result. AI does the work. You get the outcome.
                Platform earns on execution.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-4 mt-3 pt-3 border-t border-border/30 text-xs text-muted-foreground">
            <span className="flex items-center gap-1">
              <CheckCircle className="w-3 h-3 text-green-400" /> Free preview
              always
            </span>
            <span className="flex items-center gap-1">
            ...
            <span className="flex items-center gap-1">
              <Zap className="w-3 h-3 text-cyan-400" /> Instant execution
            </span>
          </div>
        </div>
          ...
          {filtered.map(agent => (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <ArrowRight
                  className={`w-4 h-4 text-muted-foreground transition-transform ${selectedAgent?.id === agent.id ? "rotate-90" : ""}`}
                />
              </div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="p-3 rounded-lg bg-secondary/30 border border-border/30">
                      <div className="text-xs font-medium text-muted-foreground mb-1 flex items-center gap-1">
                        <CheckCircle className="w-3 h-3 text-green-400" /> Free
                        Preview
                      </div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {(["basic", "premium", "power"] as const).map((tier, i) => {
                      ...
                      return (
                        ...
                        >
                          <div
                            className={`text-xs font-bold ${t.color} flex items-center gap-1`}
                          >
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={e => {
                        e.stopPropagation();
                        handleUnlock(agent, selectedTier);
                      }}
                    >
        ...
        <div className="card p-4 bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20">
          ...
          <Button
            ...
            size="sm"
            onClick={() =>
              toast.info("Connect Stripe to activate subscriptions.")
            }
          >
