      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="col-span-2">
            ...
            <Card
              className={`bg-gradient-to-br ${step.color} bg-opacity-10 border-opacity-30 border p-8 mb-6`}
            >
              <div className="flex items-start gap-6">
                <div
                  className={`p-4 bg-gradient-to-br ${step.color} rounded-lg`}
                >
                    ...
                    <div className="mt-4 p-3 rounded-xl bg-black/30 border border-amber-500/20">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {AIRDROP_TOKENS.map(t => (
                          <span
                            key={t.symbol}
                            className={`text-xs font-mono font-bold ${t.color}`}
                          >
                            {t.icon} {t.amount} {t.symbol}
                          </span>
                        ))}
                      </div>
                    </div>
        ...
        {currentStep === ONBOARDING_STEPS.length - 1 && (
          <Card className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 border-purple-500/30 p-6">
            <div className="flex items-center gap-4">
              ...
              <Button
                onClick={handleSkip}
                className="ml-auto bg-purple-600 hover:bg-purple-600"
              >
                Go to Dashboard
              </Button>
            </div>
