      ...
      <div className="border-b border-white/10 bg-[oklch(0.1_0.03_270)]/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant="outline"
              className="text-[oklch(0.7_0.2_25)] border-[oklch(0.7_0.2_25)]/40 text-xs"
            >
              POWER USER
            </Badge>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-white/90 mb-1">
                Scalable Observability Layer
              </p>
              <p className="text-xs text-white/50 leading-relaxed">
                Unhidden Mode provides full system transparency: live event
                streams, AI decision logs, simulation control, economy flows,
                and architecture visualization. This is the developer + power
                user layer — not a consumer feature. All tools are read-only or
                safely sandboxed.
              </p>
            </div>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <Badge
                            variant="outline"
                            className={`text-[10px] mt-0.5 ${accent}`}
                          >
                            {section.tools} tools
                          </Badge>
                        </div>
            ...
            <CardContent className="p-4">
              <div className="font-mono text-xs space-y-2">
                {RECENT_EVENTS.map((ev, i) => (
                  ...
                  >
                    ...
                    <span
                      className={`uppercase shrink-0 w-12 ${levelColor[ev.level]}`}
                    >
                      [{ev.type}]
                    </span>
              ...
              <Link href="/system-observability">
                <Button
                  variant="ghost"
                  size="sm"
                  className="mt-3 text-xs text-white/40 hover:text-white/70 w-full"
                >
        ...
        <div>
          ...
          <div className="space-y-2">
            {[
              ...
              {
                label: "System Observability + Control + Simulation",
              ...
              >
                <div className="text-white/30 font-mono text-xs w-4">
                  {i + 1}
                </div>
                ...
                {i === 3 && (
                  <Badge
                    variant="outline"
                    className="text-[oklch(0.7_0.2_25)] border-[oklch(0.7_0.2_25)]/40 text-[10px]"
                  >
                    YOU ARE HERE
                  </Badge>
                )}
