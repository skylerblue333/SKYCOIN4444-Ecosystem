        ...
        <div className="card p-4">
          <div className="flex items-center justify-between mb-2 text-xs">
            ...
            <span className="font-medium">
              {Math.round((complete / PHASES.length) * 100)}%
            </span>
          </div>
          ...
          <div className="flex gap-4 mt-2 text-xs text-muted-foreground">
            ...
            <span className="flex items-center gap-1">
              ...
              {PHASES.length - complete - inProgress} pending
            </span>
          </div>
        </div>
            ...
            <div key={phase.step}>
              <div className={`card p-4 border ${cfg.bg}`}>
                <div className="flex items-start gap-3">
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 ${phase.status === "complete" ? "bg-green-500/20" : phase.status === "in-progress" ? "bg-yellow-500/20" : "bg-secondary/50"}`}
                  >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-1 mb-2">
                      {phase.items.map(item => (
                        ...
                        >
                          <div
                            className={`w-1.5 h-1.5 rounded-full shrink-0 ${phase.status === "complete" ? "bg-green-400" : phase.status === "in-progress" ? "bg-yellow-400" : "bg-secondary"}`}
                          />
                          {item}
                        </div>
                      ))}
