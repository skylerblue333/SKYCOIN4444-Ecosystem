            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-lg font-bold text-white">
                  {selectedLessonIdx + 1}/{selectedCourse.lessons}
                </p>
              </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button
                      variant="outline"
                      onClick={() =>
                        setSelectedLessonIdx(Math.max(0, selectedLessonIdx - 1))
                      }
                    ...
                    >
                      {selectedLessonIdx === selectedCourse.lessons - 1
                        ? "Complete Course"
                        : "Next Lesson"}
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          ...
          <Card className="bg-slate-900/50 border border-white/10">
            <CardContent className="p-4">
              ...
              <p className="text-3xl font-bold text-white">
                {COURSES.reduce(
                  (sum, c) => sum + parseFloat(c.duration),
                  0
                ).toFixed(1)}
              </p>
            </CardContent>
                ...
                >
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge
                        className={`text-xs px-2 py-1 ${LEVEL_COLORS[course.level]}`}
                      >
                        {course.level}
                      </Badge>
                    </div>
                  ...
                  >
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex gap-2">
                        {enrolledCourses.has(course.id) ? (
                          <Button
                            className="flex-1 bg-green-600/20 text-green-300"
                            onClick={() => setSelectedCourse(course)}
                          >
                            <Play className="w-4 h-4 mr-2" />
                            Continue
                          ...
                          <Button
                            className="flex-1 bg-cyan-500/20 text-cyan-300"
                            onClick={() => handleEnroll(course.id)}
                          >
                            <Play className="w-4 h-4 mr-2" />
                            Enroll
