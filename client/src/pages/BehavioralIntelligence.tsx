      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription>
              Weekly churn rate predictions vs actual
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {segments.map(segment => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge
                      className={
                        segment.churnRisk < 0.2
                          ? "bg-green-900 text-green-300"
                          : segment.churnRisk < 0.5
                  ...
                  <div className="flex justify-between text-xs text-gray-400">
                    ...
                    <span>
                      Sentiment: {Math.round(segment.sentiment * 100)}/100
                    </span>
                  </div>
                </button>
              ))}
        ...
        <Card className="bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription>
              Engagement, retention, and LTV metrics
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
        ...
        {selectedSegmentData && (
          <Card className="bg-slate-800/50 border-slate-700">
            <CardHeader>
              <CardTitle className="text-white">
                {selectedSegmentData.name} Analysis
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="p-3 bg-slate-700/30 rounded border border-slate-600">
                  ...
                  <p className="text-2xl font-bold text-white">
                    {Math.round(selectedSegmentData.churnRisk * 100)}%
                  </p>
                </div>
                <div className="p-3 bg-slate-700/30 rounded border border-slate-600">
                  <p className="text-xs text-gray-400">LTV</p>
                  <p className="text-2xl font-bold text-white">
                    ${selectedSegmentData.ltv}
                  </p>
                </div>
                <div className="p-3 bg-slate-700/30 rounded border border-slate-600">
                  <p className="text-xs text-gray-400">Sentiment</p>
                  <p className="text-2xl font-bold text-white">
                    {Math.round(selectedSegmentData.sentiment * 100)}/100
                  </p>
                </div>
              </div>
