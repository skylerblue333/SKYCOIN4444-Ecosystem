    ...
    <div className="min-h-screen bg-background p-6 max-w-5xl mx-auto space-y-8">
      ...
      <div>
        ...
        <div className="mt-3 p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-xl text-sm text-cyan-400">
          "ShadowChat is a distributed AI-native OS deployed on cloud
          microservices with event-driven simulation, real-time communication,
        ...
        <div className="flex flex-wrap items-center gap-2 text-sm">
          {[
            ...
            <div key={step} className="flex items-center gap-2">
              <div className="px-3 py-1.5 rounded-lg bg-secondary/50 text-xs font-medium">
                {step}
              </div>
              {i < arr.length - 1 && (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {SERVICES.map(s => (
            <div key={s.name} className="card p-4 flex items-start gap-3">
              <div
                className={`px-2 py-1 rounded-lg text-xs font-mono font-bold ${s.color}`}
              >
                {s.name}
              </div>
      ...
      <div className="card p-5">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            >
              <span className="text-yellow-400 font-mono text-xs shrink-0">
                IF {trigger}
              </span>
