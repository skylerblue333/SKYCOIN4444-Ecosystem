    ...
    <div className="min-h-screen bg-background">
      <div className="container py-8 max-w-5xl">
        <PageHeader
          ...
          subtitle="Complete quests, earn SKY444 rewards, and level up your reputation"
        />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {filteredQuests.map(quest => {
                ...
                return (
                  <Card
                    key={quest.id}
                    className={`border-border/50 ${quest.completed ? "border-purple-500/20 bg-purple-600/5" : ""}`}
                  >
                    <CardContent className="pt-6">
                        ...
                        {quest.completed ? (
                          isClaimed ? (
                            ...
                            <Button
                              size="sm"
                              onClick={() =>
                                claimReward(quest.id, quest.reward)
                              }
              ...
              <CardContent>
                <div className="space-y-3">
                  {dailyQuests.map((q, i) => (
                    <div
                      key={i}
                      className={`flex items-center justify-between p-3 rounded-lg ${q.completed ? "bg-purple-600/10 border border-purple-500/20" : "bg-muted/30"}`}
                    >
