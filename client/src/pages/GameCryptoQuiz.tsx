        ...
        {gameState === "idle" && (
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Answer 10 blockchain questions. Every correct answer donates
              SKY444 to the Education Fund. You have 20 seconds per question.
            </p>
            ...
            <Button
              onClick={startGame}
              className="bg-blue-500 hover:bg-blue-600 text-white gap-2 h-12 px-8 text-base"
            >
        ...
        {(gameState === "playing" || gameState === "answered") && (
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              />
              <div
                className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-bold transition-colors ${timeLeft <= 5 ? "bg-red-500/20 text-red-400" : "bg-card/50 text-foreground"}`}
              >
            ...
            <div className="space-y-3">
              {question.options.map((opt, i) => {
                ...
                return (
                  ...
                  >
                    <span className="w-7 h-7 rounded-full border border-current/30 flex items-center justify-center text-sm font-bold shrink-0">
                      {String.fromCharCode(65 + i)}
                    </span>
                    <span className="text-sm font-medium">{opt}</span>
                    {gameState === "answered" && i === question.answer && (
        ...
        {gameState === "finished" && (
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
              {score}/{QUESTIONS.length} correct · {accuracy}% accuracy
            </p>
            ...
            <div className="rounded-xl border border-purple-500/30 bg-purple-600/5 p-4 mb-6 max-w-sm mx-auto">
              ...
              <p className="text-xs text-muted-foreground">
                {donated} SKY444 has been donated on your behalf!
              </p>
            </div>
