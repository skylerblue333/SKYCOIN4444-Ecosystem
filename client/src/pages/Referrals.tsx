...
export default function Referrals() {
  ...
  const currentTier =
    TIERS.find(t => referralCount >= t.min && referralCount < t.max) ||
    TIERS[0];
    ...
    return (
      ...
      >
        <div className="text-center p-8">
          ...
          <Link href="/">
            <Button
              style={{ background: "oklch(0.72 0.28 305)", color: "white" }}
            >
              Sign In
            </Button>
          </Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <code className="flex-1 text-sm truncate text-white font-mono">
                {referralLink}
              </code>
              <Button
                size="sm"
            ...
            {nextTier && (
              <>
                <div className="flex items-center justify-between text-xs mb-1">
                  <span style={{ color: "oklch(0.50 0.020 275)" }}>
                    Progress to {nextTier.name}
                  </span>
                  <span className="text-white">
                    {referralCount}/{nextTier.min}
                  </span>
                </div>
                <div
                ...
                <p
                  ...
                  style={{ color: "oklch(0.50 0.020 275)" }}
                >
                  {nextTier.min - referralCount} more referrals to unlock{" "}
                  {nextTier.name} — {nextTier.reward}
                </p>
              </>
            )}
          </div>
              ...
              {(tree as any).children.slice(0, 10).map((ref: any) => (
                ...
                >
                  <div
                    ...
                    style={{ background: "oklch(0.72 0.28 305 / 0.20)" }}
                  >
                    {ref.avatar ? (
                      <img
                        src={ref.avatar}
