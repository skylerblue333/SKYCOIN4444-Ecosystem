...
export default function GameTokenTap() {
  ...
  const tapsPerSec =
    timeLeft < 30 ? (taps / (30 - timeLeft)).toFixed(1) : "0.0";
        ...
        {gameState === "idle" && (
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
              Tap as fast as you can for 30 seconds! Every tap donates SKY444 to
              the Clean Water Initiative. Build combos for multipliers!
            </p>
            ...
            <Button
              onClick={startGame}
              className="bg-purple-600 hover:bg-purple-600 text-white gap-2 h-12 px-8 text-base"
            >
        ...
        {gameState === "playing" && (
          <div className="w-full">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div
                className={`text-center px-4 py-2 rounded-xl transition-all ${combo >= 10 ? "bg-red-500/20 border border-red-500/30" : combo >= 5 ? "bg-orange-500/20 border border-orange-500/30" : "bg-card/30 border border-border/50"}`}
              >
                <p
                  className={`text-2xl font-bold ${combo >= 10 ? "text-red-400" : combo >= 5 ? "text-orange-400" : "text-foreground"}`}
                >
                  {combo >= 10 ? "3x" : combo >= 5 ? "2x" : "1x"}
                </p>
              ...
              <div className="text-center">
                <p
                  className={`text-2xl font-bold ${timeLeft <= 10 ? "text-red-400" : "text-foreground"}`}
                >
                  {timeLeft}s
                </p>
            ...
            >
              ...
              {particles.map(p => (
                <div
                  key={p.id}
                  className="absolute pointer-events-none text-purple-400 font-bold text-sm animate-bounce"
                  style={{
                    left: p.x,
                    top: p.y,
        ...
        {gameState === "finished" && (
          <div className="text-center w-full">
            ...
            <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/5 p-4 mb-6">
              ...
              <p className="text-xs text-muted-foreground">
                {donated} SKY444 donated to provide clean water!
              </p>
            </div>
