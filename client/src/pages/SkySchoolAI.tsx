      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-gray-400">
            Learn from the world's best AI teacher — personalized education at
            scale
          </p>
        </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {course.skills.map(skill => (
                    <Badge key={skill} className="bg-gray-700 text-xs">
                      {skill}
                    </Badge>
                  ))}
                </div>
