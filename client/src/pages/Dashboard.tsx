...
const CRYPTO_CARDS = [
  ...
  },
  {
    ...
    held: "1.2M",
    color: "#06b6d4",
    data: generateSparkline(0.01, 0.06),
  },
  {
    symbol: "BTC",
    name: "Bitcoin",
    ...
    held: "0.042",
    color: "#f97316",
    data: generateSparkline(67400, 0.02),
  },
  {
    symbol: "ETH",
    name: "Ethereum",
    ...
    held: "1.5",
    color: "#8b5cf6",
    data: generateSparkline(3240, 0.03),
  },
];
...
export default function Dashboard() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => setActivityIdx(i => (i + 1) % LIVE_ACTIVITIES.length),
      4000
    );
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {CRYPTO_CARDS.map(c => (
              <div
                key={c.symbol}
                className="rounded-2xl border border-slate-800/60 bg-slate-900/60 p-4 hover:border-slate-700 transition-colors cursor-pointer"
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge
                    className={`text-xs border-0 font-bold ${c.change >= 0 ? "bg-emerald-500/15 text-emerald-400" : "bg-red-500/15 text-red-400"}`}
                  >
                    {c.change >= 0 ? "+" : ""}
                    {c.change}%
                  </Badge>
        ...
        <div className="rounded-2xl border border-slate-800/60 bg-slate-900/40 p-5">
          ...
          <div className="space-y-3">
            {LIVE_ACTIVITIES.slice(0, 5).map((a, i) => (
              <div
                key={i}
                className={`flex items-start gap-3 p-3 rounded-xl border border-slate-800/40 bg-slate-950/40 transition-all ${i === 0 ? "border-cyan-500/20 bg-cyan-500/5" : ""}`}
              >
                <div
                  className={`w-10 h-10 rounded-xl ${a.color} flex items-center justify-center shrink-0`}
                >
