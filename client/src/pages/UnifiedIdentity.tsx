      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-white/50">
            Profile · Wallet · Reputation · Social Graph · DID — all in one
            sovereign identity
          </p>
        </div>
        ...
        <CardContent className="p-4 -mt-12">
          <div className="flex items-end gap-4 mb-4">
            <Avatar className="w-20 h-20 border-4 border-background">
              <AvatarFallback className="gradient-psychedelic text-white text-2xl font-bold">
                S
              </AvatarFallback>
            </Avatar>
            <div className="pb-2">
            ...
            >
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex gap-1 mt-1">
                      {app.perms.map(p => (
                        <Badge
                          key={p}
                          className="text-xs bg-white/5 text-white/40 border-white/10"
                        >
                          {p}
                        </Badge>
                      ))}
                  ...
                  <Badge
                    className={`text-xs border ${app.status === "primary" ? "bg-purple-500/20 text-purple-300 border-purple-500/30" : "bg-green-500/20 text-green-300 border-green-500/30"}`}
                  >
                    {app.status}
                  </Badge>
                </div>
