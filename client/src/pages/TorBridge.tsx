...
export default function TorBridge() {
  ...
  const filteredBridges = TOR_BRIDGES.filter(
    b => selectedBridgeType === "all" || b.type === selectedBridgeType
  );
    ...
    <div className="container py-8 max-w-5xl animate-page-in">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Connect to the Tor anonymity network. Configure bridges to bypass
          censorship and access .onion services.
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              The Tor Project is a 501(c)(3) nonprofit. Tor Browser is used by
              journalists, activists, whistleblowers, and privacy-conscious
              individuals worldwide. It is legal in the US, EU, UK, Canada,
              Australia, and most other countries. Check your local laws if you
              are in a restrictive jurisdiction.
            </p>
          </div>
        </div>
      </Card>
        ...
        <div className="space-y-6">
          ...
          <Card className="p-5 border-border/30 bg-card/50">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-1">
                {["all", "obfs4", "meek-azure", "snowflake"].map(t => (
                  <button
                    key={t}
                    onClick={() => setSelectedBridgeType(t)}
                    className={`px-2 py-1 rounded-lg text-[10px] font-medium transition-all ${selectedBridgeType === t ? "bg-primary/20 text-primary" : "bg-secondary/40 text-muted-foreground hover:bg-secondary"}`}
                  >
                    {t}
                  </button>
                ))}
              ...
              {filteredBridges.map((bridge, idx) => (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      <Badge className="text-[9px] h-4 bg-green-500/10 text-green-400 border-green-500/20">
                        {bridge.type}
                      </Badge>
                    ...
                    <Button
                      ...
                      variant="ghost"
                      className="h-6 w-6"
                      onClick={() => copyBridge(bridge.address, idx)}
                    >
                      {copiedIdx === idx ? (
            ...
            <p className="text-[10px] text-muted-foreground mt-3">
              Copy a bridge address and paste it into Tor Browser → Settings →
              Connection → Bridges → Add a Bridge Manually.
            </p>
          </Card>
        </div>
              ...
              {ONION_BOOKMARKS.map(b => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <code className="text-[9px] text-muted-foreground font-mono truncate flex-1 mr-2">
                      {b.url.slice(0, 35)}...
                    </code>
                    <Button
                      size="icon"
          ...
          <Card className="p-4 border-border/30 bg-card/50">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex justify-between">
                <span className="text-muted-foreground">Active relays</span>
                <span className="text-green-400 font-medium">7,000+</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-green-400 font-medium">2M+</span>
              </div>
              <div className="flex justify-between">
