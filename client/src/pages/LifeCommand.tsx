...
export default function LifeCommand() {
  ...
  const dimensions: LifeDimension[] = [
    ...
    },
    {
      ...
      score: Math.min(
        100,
        Math.round(level * 5 + (today?.learning?.length ?? 0) * 10)
      ),
      trend: "up",
      color: "text-blue-400",
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              ...
              <Badge
                className={`${rankColor} bg-transparent border border-current text-xs mt-1`}
              >
                {rank}
              </Badge>
            </div>
                    ...
                    <div className="p-4 bg-white/5 rounded-lg">
                      ...
                      <div className="text-white font-semibold">
                        {((twin as Record<string, unknown>)
                          .personality as string) ?? "Adaptive"}
                      </div>
                    </div>
                    <div className="p-4 bg-white/5 rounded-lg">
                      <div className="text-xs text-white/40 mb-1">
              ...
              <div className="relative">
                ...
                <div className="space-y-4 pl-10">
                  {[
                    ...
                    {
                      date: "Level " + level,
                      event: `Reached level ${level}`,
                      icon: "🏆",
                      type: "level",
                    },
                    {
                      date: "Reputation",
                      event: `Earned ${repScore} reputation points`,
                      icon: "⭐",
                      type: "rep",
                    },
                  ].map((item, i) => (
                    <div key={i} className="relative flex items-start gap-3">
                      ...
                      <div className="p-3 rounded-lg bg-white/5 border border-white/10 flex-1">
                        <div className="text-xs text-yellow-500/60 mb-1">
                          {item.date}
                        </div>
