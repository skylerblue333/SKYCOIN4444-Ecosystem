...
const Scalable = lazy(() => import("./pages/Enterprise"));
const ScalableAPI = lazy(() => import("./pages/EnterpriseAPI"));
const ScalableAnalytics = lazy(() => import("./pages/EnterpriseAnalytics"));
            ...
            <main className="flex-1">
              <Suspense fallback={<div>Loading...</div>}>
                <Switch>
                  ...
                  />
                  <Route
                    path="/accordionnavigation"
                    component={AccordionNavigation}
                  />
                  <Route path="/accountsettings" component={AccountSettings} />
                  <Route
                    path="/achievementbadges"
                  ...
                  <Route
                    path="/adminwalletmanager"
                    component={AdminWalletManager}
                  />
                  <Route
                    path="/advancedadminpanel"
                  ...
                  />
                  <Route
                    path="/attributionmodeling"
                    component={AttributionModeling}
                  />
                  <Route
                    path="/audiencesegmentation"
                  ...
                  <Route
                    path="/companysimulator"
                    component={CompanySimulator}
                  />
                  <Route
                    path="/competitiveradar"
                  ...
                  />
                  <Route
                    path="/comprehensiveecosystemlanding"
                  ...
                  />
                  <Route
                    path="/contributioninterface"
                    component={ContributionInterface}
                  />
                  <Route
                    path="/conversationarchive"
                  ...
                  <Route
                    path="/creatorintelligence"
                    component={CreatorIntelligence}
                  />
                  <Route
                    path="/creatormonetization"
                  ...
                  <Route
                    path="/deploymentpipeline"
                    component={DeploymentPipeline}
                  />
                  <Route
                    path="/deprecationpolicy"
                    component={DeprecationPolicy}
                  />
                  <Route
                    path="/derivativestrading"
                    component={DerivativesTrading}
                  />
                  <Route
                    path="/destinationguide"
                  ...
                  <Route
                    path="/emptysearchstate"
                    component={EmptySearchState}
                  />
                  <Route
                    path="/engagementmetrics"
                  ...
                  <Route
                    path="/languageexchangeadmin"
                    component={LanguageExchangeAdmin}
                  />
                  <Route
                    path="/languagepartnerdiscovery"
                  ...
                  />
                  <Route
                    path="/realtimestreaming"
                    component={RealTimeStreaming}
                  />
                  <Route
                    path="/rebalancingtools"
                  ...
                  />
                  <Route
                    path="/segmentationanalysis"
                    component={SegmentationAnalysis}
                  />
                  <Route
                    path="/selectdropdownform"
                    component={SelectDropdownForm}
                  />
                  <Route
                    path="/selfhealinginfra"
                  ...
                  <Route
                    path="/slippageprotection"
                    component={SlippageProtection}
                  />
                  <Route
                    path="/smartcontractaudit"
                    component={SmartContractAudit}
                  />
                  <Route
                    path="/smartcontractviewer"
                  ...
                  <Route
                    path="/socialmediacampaigns"
                    component={SocialMediaCampaigns}
                  />
                  <Route
                    path="/solanavalidatorsetup"
                  ...
                  />
                  <Route
                    path="/translationenabledcommunity"
                    component={TranslationEnabledCommunity}
                  />
                  <Route
                    path="/translationenabledsocialfeed"
                    component={TranslationEnabledSocialFeed}
                  />
                  <Route
                    path="/transparencyreports"
                  ...
                  <Route
                    path="/typingindicators"
                    component={TypingIndicators}
                  />
                  <Route
                    path="/unhiddeninterface"
